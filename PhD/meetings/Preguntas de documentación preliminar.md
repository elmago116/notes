...
Proxima reunión: jueves 15 de enero 3:30 para [[documentación final y "manuales" del prototipo UBXAT]]

Se va Thomas y se revisan las expectativas de las fechas: 

- 22 de enero-> Presentaciones de avances en el proceso de investigación de Elena y Matheus
(revisión de las mismas el lunes 12) al grupo interno del proyecto. 
- 21 de enero-> reunión de aspectos operativos de la primera sesión (conversación tentativa con Chus y Elena)
- 28 de enero -> primer encuentro de cocreación citada ya por Nuria ([[co]])
- Buscar fecha en la semana entre el 9 y 15 para hacer una sesión explicando usos de MCPs
