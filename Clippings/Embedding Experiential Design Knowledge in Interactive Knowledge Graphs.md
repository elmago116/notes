...
authors:
  - Ye Wang, Nicole Goridkov, Vivek Rao, Dixun Cui, Daniele Grandi, Kosa Goucher-Lambert
year: 2023
type: journal-article
journal: " Journal of Mechanical Design (JMD)"
doi: 10.2307/41166415
base: clippings
source: Manual
tags:
  - Tech/KG
  ...
  - UX
publisher: ASM
url: https://doi.org/10.1115/1.4056800
apa_citation:
---
...
[[Development of digital humanities research and pedago]]

DOI: 10.4324/9781032707211-6
This chapter has been made available under a CC-BY-NC-ND 4.0 license.
1 Introduction
The discipline now known as Digital Humanities (DH) has origins in several differ-
ent fields. The 
most well‑known story is its origin in linguistics and English studies, 
...
absolutely necessary’ (Nyhan & Flinn, 2016a, p.
 14). This chapter seeks to 
contrib-
...
duction enterprise (Jones, 2013, p.
 31). Recognising the significance of 
diversity in 
...
need to move beyond traditional
 Anglophone and male‑dominated perspectives, to 
embrace a more inclusive and representative DH landscape (ADHO, 2022; Estill 
et
 al., 2022; Gao et al., 2022; Nyhan, 2023). These efforts have sought to disman‑
tle historical 
hierarchies, disrupt exclusionary practices, and amplify marginalised 
...
Development of digital humanities research and pedagogy at UCL 73
milestone was probably the establishment of UCL Centre for Digital Humanities 
(UCLDH), formally launched 
in 2010, but active from 2009 onwards. At the same 
...
wick et
 al., 2011). For a significant time before the 
foundation of these centres, 
...
Andrew Rosta).
According to the Index of DH Conferences (Weingart et
 al., 2023),2 the first 
...
mal inauguration in 1973 and its 
first so‑titled conference in 1974. This associa‑
...
COCOA: A Wor
d Count and Concordance Generator in the journal Computers 
...
to have been one of the canonical DH journals
 – Computers and the Humanities 
(Day & Marriott, 1976). COCOA 
...
name of ‘Miss
 S. M. Petty’ with her affiliation as ‘the 
...
she joined the 
Oxford University Computing Services in 1975. Her first formal as‑
...
a Team Tag Consistently? Experiences on the Orlando Project (Butler et
 al., 1999). 
...
Development of digital humanities research and pedagogy at UCL 75
which exemplified their potential for identifying land areas 
with favourable pros‑
...
76 Jin Gao et al.
and Literature, as well as director of the SEU at UCL in 1981. From 1986 to 1988, 
Greenbaum served as the Dean of 
the Faculty of Arts and Humanities at UCL, 
...
tation (Shiode et
 al., 1998). It was the first among UK universities 
to employ 
...
et
 al., 1998). Over the years, CASA and the 
Bartlett Faculty have made their 
contributions to the field through pioneering projects and collaborations around 
the world, e.g., Africa Centre/I‑Sense project (Manley et
 al., 2016), GNOMEs 
...
feminist studies (Sheppard et
 al., 2023) and relevant history studies (Cheshire, 
2017), scholars in CASA and the Bartlett have collaborated on projects with 
UCLDH, such as QRator (Hudson‑Smith et
 al., 2012), Textal (Terras et  al., 
...
Development of digital humanities research and pedagogy at UCL 77
The field of Human‑Computer Interaction (HCI) is also relevant 
to research in 
...
was established, on topics including digital libraries (Buchanan et
 al., 2006) and 
...
across Europe (Ceccaldi et
 al., 2020), and the Global Disability Innovation (GDI) 
Hub, which operates in 61 
countries and is the world’s first and only WHO Collabo‑
...
Melissa Terras (Pal et
 al., 2016), general heritage and manuscript imaging (Giaco‑
metti et al., 2014), and a collaborative doctoral project on multi‑spectral images 
of parchment (Giacometti, 2014). Imaging techniques and expertise 
at UCL have 
...
(CAAL) project (Nebbia et
 al., 2021), launched by UCL IoA and led by Tim 
Wil‑
...
78 Jin Gao et al.
integrating information from regional entities 
into a unified multilingual reposi-
...
of digital technology and the humanities (Warwick et
 al., 2011). The UCL
 Grand 
...
and the Arts and Humanities, the centre grew and since
 2021 is now a part 
of the 
...
Development of digital humanities research and pedagogy at UCL 79
of the field and made 
the establishment of UCLDH a logical progression. However, 
...
80 Jin Gao et al.
and associate directors as dictat
ed by the centres’ constitution. The website lists 
...
highly cited by the wider field, e.g., (Warwick et
 al., 2012; Terras et  al., 2013; 
Nyhan & Flinn, 2016a). 
In the third section of this chapter, therefore, we present 
...
Development of digital humanities research and pedagogy at UCL 81
historical context. By looking through the collaborations at UCL from 
a quantita‑
...
and oral historie
s (Nyhan & Flinn, 2016a; Nyhan & Passarotti, 2019), statistical 
...
social network analyses (Grandjean, 2016; Gao et
 al., 2017). Among these meth ‑
odologies, co‑authorship network visualisation has emerged as a valuable tool for 
helping comprehend the collabo
rative dynamics and scholarly influences within 
the field (Gao et al., 2022).
This section presents a quantitative exploration of the collaboration networks 
formed by scholars affiliated with 
UCL who participated in DH and proto‑DH con‑
...
and so cannot be considered complete (Weingart et
 al., 2023). The ADHO confer‑
ence seems to be fully ingested, but many others are not (for example, ALLC, 
EADH, DHC 
are included, and at the time of writing in 2023, up until 2018). Con‑
...
In general, it seems that DH at UCL has taken the lead in significant areas
 – one 
of which is in the number of co‑authored conference 
papers, and another is the 
...
multi‑authored and 47% of University of Cambridge scholars. Figure
 5.1 shows the 
number of single‑authored and multi‑authored papers presented by UCL scholars 
each year at DH conferences 
based on the data held in the Index of DH Confer ‑
ences (Weingart et al., 2023).

82 Jin Gao et al.
There are many aspects to unpack and compare, but our research here mainly 
focuses on investigating the collaborative network of UCL scholars. Addition‑
ally, 
when counting scholars’ affiliations, we are aware that there are many cases 
...
papers and multi‑authored papers at UCL, peaking in 2013 
(a clear anomaly that 
...
ferences (Weingart et
 al., 2023), authors affiliated with KCL have on average 
3.9 
...
Development of digital humanities research and pedagogy at UCL 83
As shown in Table 5.1, we can see the total number of papers each author with 
UCL 
as an affiliation presented at the DH conferences in our dataset, their aver ‑
...
have identified the author 
gender based on a well‑tested name‑gender assignment 
method (Sugimoto et  al., 2015) and our knowledge of these authors. If we have 
mis‑ gendered any individuals through this method of classification, 
we apologise. 
...
three most productive, with 88 papers in total
 – Terras, Warwick, and Nyhan. In 
comparison, four male scholars contributed 
20 papers in total. Compared to other 
...
ingart & Eichmann‑Kalwara, 2017; Gao et
 al., 2022).
In the visualisation of the co‑authorship network that follows, scholars are 
the 
...
84 Jin Gao et al.
output‑centric view of characteristics such as connectivity levels and the promi‑
nence of scholars. 
VOSviewer 1.6.7 and Gephi 0.9.2 have been used for network 
...
highlighted 
in orange, and average publication year colour‑coded in a heatmap 
timeline.
As illustrated in Figure  5.2, Co‑authorship network of UCL authors and their 
collaborators at DH conferences, data 
from (Weingart et al., 2023) 1970 to 2023 
...
ars] and Figure  5.3, specific nodes (scholars) within the network act as 
crucial 
...
Development of digital humanities research and pedagogy at UCL 85
connectors, 
evident through higher betweenness centrality values computed using 
...
previous studies (Gao et
 al., 
2022), female scholars in DH are often the main forces 
...
erence, heatmap timeline version, data from (W
eingart et
 
al., 2023) 1970 to 2023.
...
humanities pioneers always strove to promote, from the infancy of the field.
4
...
room has been a feature of digital humanities at UCL, and it has come 
in two 
...
Development of digital humanities research and pedagogy at UCL 87
in November 2007 (Apple, 2007) and took time to have its full impact on the way 
...
2012. However
, in general, students tended to focus on textual content in the class‑
...
the integration of object‑based learning within the DH programme (Nyhan et
 al., 
...
The module Introduction to Digitisation has partnered with the 
Asia Department 
...
tive approach (Kador et
 al., 2018, p. 167). This project also reflects on how we foster
...
(V oyant, Antconc, etc.) and at geospatial work (GIS), which could lead to research 
findings in traditional humanities disciplines, and which could act as a springboard 
into PhD study.

88 Jin Gao et al.
The focus on technology and skills development was an important part of the 
programme as feedback 
from both students and employers made it clear that skills 
...
Development of digital humanities research and pedagogy at UCL 89
Digital Dunhuang project in China, launched in 2016 (2017 in English), which 
...
caves virtually on their phones (Dunhuang 
Academy, 2016). The Palace Museum 
...
90 Jin Gao et al.
about how typical their own experiences with technology have been. For example, 
students in China are 
often surprised that Western students on the programme do 
...
5
 Widening the engagement at UCL
The growth and development of UCLDH, together with the taught graduate pro‑
gramme, coincided significantly with the year‑on‑year 
...
(Tsui, 2020; Chen & Tsui, 2020; Wang et
 al., 2020), and this growth together 
...
While the 
universities strive to construct strategic partnerships at a high level 
...
Development of digital humanities research and pedagogy at UCL 91
UCL and UCLDH in China, speaking at universities and conferences, and perhaps 
(as has happened on several occasions) at their own university.
Research trips are often reciprocal 
and UCLDH was delighted to host Professor 
...
6
 Conclusion
Reviewing the institutional history of DH holds significant 
...
92 Jin Gao et al.
that our collective efforts are informed and guided by a broader understanding of 
the field’s 
evolution. This knowledge empowers us to actively work towards creat‑
...
Notes
 1 We extend our gratitude to Prof. Julianne Nyhan, Prof. Melissa Terras, Prof. Oliver 
Duke‑Williams, Prof. Andrew Rosta, Dr Scott B Weingart, Dr Pang Rui, and Dr Bonnie 
Buyuklieva, for their generous contributions of insights and comments
, offered amidst 
their busy schedules, which significantly enriched this chapter.
 2 We acknowledge that this dataset does not represent the entirely of UCL’s (or any other 
institutional) representation at DH conferences 
during this period. Nor does it include 
...
basis for the network analysis in this study.
 3 The average year of attendance for scholars at DH 
conferences is calculated by finding 
...
We acknowledge that the problema
tic aspects of the Galton collection were put front 
and centre in the teaching as indicated in (Nyhan et al., 2014).
References
ADHO. (2022). Response to “The circus we deserve? A front row look at the organization 
of the annual academic conference for the Digital Humanities”. Digital Humanities Quar‑
terly, 16(4). http://www.digitalhumanities.org/dhq/vol/16/4/000664/000664.html
Apple. (2007, January 9). Apple reinvents the phone with iPhone. Apple Newsroom (United  
Kingdom). https://www.apple.com/uk/newsroom/2007/01/09Apple‑Reinvents‑the‑Phone‑ 
with‑iPhone/
Bailey, M. Z. (2011). All the digital humanists are white, all the nerds are men, but some of us 
are brave. Journal of Digital Humanities, 1(1). http://journalofdigi talhumanities.org/1–1/
all‑the‑digital‑humanists‑are‑white‑all‑the‑nerds‑are‑menbut‑  some‑of‑us‑are‑brave‑  
by‑moya‑z‑bailey/
Barron, D. W. (1973). FOR
TRAN techniques with special reference to non‑numerical ap‑
plications, A. C. Day, Cambridge University Press, 1972. No. of pages: 96. Price: £2·50. 
Software: Practice and Experience, 3(4), 404. https://doi.org/10.1002/spe.4380030415
Batty, M., & Evans, T. (2022, April 20). HARMONY. The Bartlett Centre for advanced spatial 
analysis. Retrieved from https://www.ucl.ac.uk/bartlett/casa/research/current‑projects/
harmony

Development of digital humanities research and pedagogy at UCL 93
Batty, M., Hudson‑Smith, A., Dodge, M., & Doyle, S. (1998, January 1). Model‑
ling virtual urban environments. CASA Working Paper 1, The Bartlett Centre for  
Advanced Spatial Analysis. https://www.ucl.ac.uk/bartlett/casa/publications/1998/jan/
casa‑working‑paper‑1
Berry, D. M., & Fagerjord, A. (Eds.). (2017). Digital humanities: Knowledge and critique 
in a digital age. Polity.
Blandford, A. (2011). UCLIC@10: The changing face of interaction design. The Ergono‑
mist, 6–7.
Bozeman, B., & Gaughan, M. (2011). How do men and women differ in research collabora‑
tions? An analysis of the collaborative motives and strategies of academic researchers. 
Research Policy, 40(10), 1393–1402. https://doi.org/10.1016/j.respol.2011.07.002
Brandeis Library. (2013, May 17). Digital Humanities: From 1851? Brandeis Library. Re‑
trieved from https://blogs.brandeis.edu/library/2013/05/17/digital‑humanities‑from‑1851/
British Library. (2022, October 8). International Dunhuang Project. The British Library. 
Retrieved from https://www.bl.uk/projects/international‑dunhuang‑project
Buchanan, G., Gow, J., Blandford, A., Rimmer, J., & Warwick, C. (2006). Representing 
aggregate works in the digital library. Lecture Notes in Computer Science (Including Sub‑
series Lecture Notes in Artificial Intelligence and Lecture Notes in Bioinformatics), 4172 
LNCS (pp.
 532–535).
Busa, R. (1950). Complete index Verborum of works of St. Thomas. Speculum: A Journal of 
Medieval Studies, XXV(1), 424–425.
Butler
, C. S. (1974, December 13). International Meeting/Annual General Meeting of the 
Association for Literary and Linguistic Computing, London.
Butler, T., Fisher, S., Hockey, S., Coulombe, G., Clements, P., Brown, S., Grundy, I., Carter, 
K., Harvey, K., & Wood, J. (1999). Can a team tag consistently? Experiences on the 
Orlando Project. ACH/ALLC/ACH/ICCH/ALLC/EADH 1999
 – Virginia. http://www2.
iath.virginia.edu/ach‑allc.99/schedule.html
CAAL. (2019, April 10). CAAL. Institute of Archaeology. https://www
.ucl.ac.uk/archaeology/ 
research/caal
Ceccaldi, E., Bardy, B., Bianchi‑Berthouze, N., Fadiga, L., V olpe, G., & Camurri, A. (2020). 
The first international workshop on multi‑scale movement technologies. Proceedings of 
the 2020 International Conference on Multimodal Interaction (pp. 895–896). https://doi.
org/10.1145/3382507.3420060
Cheshire, J. (2017, July 28). Roger 
Tomlinson’s PhD: The first in GIS – James Cheshire. James 
Cheshire’ s Blog. https://jcheshire.com/resources/roger‑tomlinsons‑phd‑the‑first‑in‑gis/
Chowdhury, I. (2013). 
A historian among scientists: Reflections on archiving the history of 
science in postcolonial India. Isis, 104(2), 371–380. https://doi.org/10.1086/670955
Crymble, A. (2021). Technology and the historian: Transformations in the digital age. Uni‑
versity of Illinois Press.
Crymble, A., & Afanador‑Llach, M. J. (2021). Digital history: The globally unequal prom‑
ise of digital tools for history: UK and Colombia’s case study. In J. Clark & A. Nye 
(Eds.), Teaching history for the contemporary world tensions, challenges and class‑
room experiences in higher education (pp.
 85–98). Springer (7; Issue 7). http://doi.
org/10.1007/978‑981‑16‑0247‑4
Day, A. C. (1972a). A London Fortran course. 
The Athlone Press.
Day, A. C. (1972b). Fortran techniques: With special reference to non‑numerical applica‑
tions (Reprinted). Cambridge University Press.

94 Jin Gao et al.
Day, A. C. (2004). Biography of Dr  A. Colin Day. Colin Day & Roget’ s Thesaurus of the 
Bible. https://colinday.co.uk/biography/index.shtml
Day
, C., & Marriott, I. (1976). Software reviews: COCOA: A word count and concord‑
ance generator. Computers and the Humanities, 10(1), 56–56. https://doi.org/10.1007/
BF02399143
Dodd, M. (Ed.). (2021). Exploring digital humanities in India: Pedagogies, practices, and 
institutional possibilities. Routledge, Taylor & Francis Group.
Dunhuang Academy. (2016). 数字敦煌 [Research project website]. Digital Dunhuang  
(数字敦煌). Retrieved from https://www.e‑dunhuang.com/
EADH. (2023a). EADH – The European Association for Digital Humanities. https://eadh.org/
EADH. (2023b). Susan Hockey—Curriculum vitae & publications. EADH  – The Euro‑
pean Association for Digital Humanities. https://eadh.org/susan‑hockey‑curriculum‑ 
vitae‑publications
Eagly, 
A. H. (2013). Sex differences in social behavior: A social‑role interpretation (1st ed.). 
Psychology Press. https://doi.org/10.4324/9780203781906
Estill, L., Guiliano, J., Ortega, É., Terras, M., Verhoeven, D., & Layne‑Worthey, G. (2022). 
The circus we deserve? A front row look at the organization of the annual academic con‑
ference for the Digital Humanities. Digital Humanities Quarterly, 16(4). https://www.
digitalhumanities.org/dhq/vol/16/4/000643/000643.html
Farringdon, M. G. (1970). Symposium on the uses of the computer in literary research: A 
conference report. Computers and the Humanities, 4(5), 315–317.
Fernández l’Hoeste, H. D., & Rodríguez, J. C. (Eds.). (2020). Digital humanities in Latin 
America. University of Florida Press.
Fuller, D. Q., & Pang, R. (2015). The International Centre for Chinese Heritage and Archae‑
ology (ICCHA): After a decade of success. Archaeology International, 18(1). https://doi.
org/10.5334/ai.1806
Galina, I. (2014). Geographical and linguistic diversity in the digital humanities. Literary 
and Linguistic Computing, 29(3), 307–316. https://doi.org/10.1093/llc/fqu005
Gao, J., Duke‑Williams, O., Mahony, S., Bold, M. R., & Nyhan, J. (2017, August). The intel‑
lectual structure of digital humanities: An author co‑citation analysis. Digital Humanities 
2017, Montreal. https://dh2017.adho.org/abstracts/083/083.pdf
Gao, J., & Hongxing, Z. (2023, June 21). Chinese Export Watercolours (CEW) Project . 
UCL Information Studies. https://www.ucl.ac.uk/information‑studies/chinese‑export‑  
watercolours‑cew‑project
Gao, J., Nyhan, J., Duke‑Williams, O., & Mahony, S. (2022). Gender influences in digital 
humanities co‑authorship networks. Journal of Documentation, 78(7), 327–350. https://
doi.org/10.1108/JD‑11‑2021‑0221
Giacometti, A. (2014). Evaluating multispectral imaging processing methodologies for  
analysing cultural heritage documents. UCL.
Giacometti, A., Gibson, A., Hess, M., Hindmarch, J., MacDonald, L., Pal, K., Robson, S., 
Terras, M., & Weyrich, T. (2014). Heritage imaging at UCL. Presented at the Annual 
Conference of Association for Historical and Fine Art Photography (AHF AP).
Gil, A., & Ortega, É. (2016). Global outlooks in digital humanities: Multilingual practices 
and minimal computing. In C. Crompton, R. J. Lane, & R. Siemens (Eds.), Doing digital 
humanities: Practice, training, research (pp.
 58–70). Taylor & Francis Group. https://
www.taylorfrancis.com/books/e/9781315707860/chapters/10.4324/9781315707860‑12
Grandjean, M. (2016). A social network analysis of 
Twitter: Mapping the digital humanities 
community. Cogent Arts & Humanities, 3(1), 1171458. https://doi.org/10.1080/23311983. 
2016.1171458

Development of digital humanities research and pedagogy at UCL 95
Hardesty, W. H., & Mann, D. D. (1973). Literary and linguistic research: The Cambridge 
symposium. Computers and the Humanities, 7(5), 287–291.
Harrison, D., & Rogers, Y . (2013). UCLIC. Interactions, 20(6), 84–87. https://doi.
org/10.1145/2533768
Hayes, B. (2017, February 6). Belles lettres meets big data. American Scientist. https://www.
americanscientist.org/article/belles‑lettres‑meets‑big‑data
HESA. (2023, January 19). Higher Education Student Statistics: UK, 2021/22—Where stu‑
dents come from and go to study. Higher Education Student Statistics. https://www.hesa.
ac.uk/news/19‑01‑2023/sb265‑higher‑education‑student‑statistics/location
Hockey, S. (2004). The history of humanities computing. In S. Schreibman, R. Siemens, & 
J. Unsworth (Eds.), A companion to digital humanities (pp.  1–19). Blackwell Publishing 
Ltd. http://doi.wiley.com/10.1002/9780470999875.ch1
Holloway, C., & Barbareschi, 
G. (2021). Disability interactions: Creating inclusive innova‑
tions. Morgan & Claypool Publishers.
Hudson‑Smith, A., Gray, S., Ross, C., Barthel, R., De Jode, M., Warwick, C., & Terras, 
M. (2012). Experiments with the internet of things in museum space: QRator. Proceed‑
ings of the 2012 ACM Conference on Ubiquitous Computing (pp.
 1183–1184). https://doi.
org/10.1
145/2370216.2370469
Jones, A., & Churchhouse, R. F. (Eds.). (1976). The computer in literary and linguistic stud‑
ies. Proceedings of the Third International Symposium. University of Wales Press.
Jones, S. E. (2013). The emergence of the digital humanities. Routledge.
Kador, T., Hannan, L., Nyhan, J., Terras, M., Chatterjee, H. J., & Carnall, M. (2018). 
 Object‑based learning and research‑based education: 
Case studies from UCL curricula.  
In J. P. Davies & N. Pachler (Eds.), Teaching and learning in higher education: Per ‑
spectives from UCL (pp.  157–176) (11; Issue 11). UCL IoE Press. https://www
.ucl‑ioe‑ 
press.com/ioe‑content/uploads/2018/05/Teaching‑and‑Learning‑in‑Higher‑Education.  
pdf
Kemman, M. (2021). Trading zones of digital history. De Gruyter Oldenbourg. https://doi.
org/10.1515/9783110682106
Kenneth, T. (2016, March 5). Reels of classic films tend to melt into goo; philanthropist 
David W. Packard won’t let that happen. Los Angeles Times. https://www.latimes.com/
entertainment/movies/la‑ca‑mn‑david‑packard‑film‑preservation‑20160306‑column.
html
Kirschenbaum, M. (2014). What is “Digital Humanities,” and why are they saying such ter‑
rible things about it? Differences, 25(1), 46–63.
Langkjær‑Bain, R. (2019). The troubling legacy of Francis Galton. Significance, 16(3), 16–
21. https://doi.org/10.1111/j.1740‑9713.2019.01275.x
Le Deuff, O. (2018). Digital humanities: History and development. ISTE Wiley.
Liu, A. (2018). Digital humanities diversity as technical problem. Alan Liu. https://doi.
org/10.21972/g21t07
Mahony, S. (2018). Cultural diversity and the digital humanities. Fudan Journal of the Hu‑
manities and Social Sciences. https://doi.org/10.1007/s40647‑018‑0216‑0
Mahony, S., & Gao, J. (2019). Linguistic and cultural hegemony in the digital humanities. 
Proceedings of the Digital Humanities Congress 2018. The Digital Humanities Institute. 
https://www.dhi.ac.uk/openbook/chapter/dhc2018‑mahony
Mahony, S., Nyhan, J., Terras, M., & Tiedau, U. (2016). Digital humanities pedagogy: In‑
tegrative learning and new ways of thinking about studying the humanities. Proceedings 
of the Digital Humanities Congress 2014, The University of Sheffield. https://www.dhi.
ac.uk/books/dhc2014/digital‑humanities‑pedagogy/

96 Jin Gao et al.
Mahony, S., & Pierazzo, E. (2012). Teaching skills or teaching methodology? In B. D. 
Hirsch (Ed.), Digital humanities pedagogy: Practices, principles and politics (pp.  215–
225). Open Book Publishers. https://doi.org/10.11647/OBP.0024.09
Makri, S., & 
Warwick, C. (2010). Information for inspiration: Understanding architects’ 
information seeking and use behaviors to inform design. Journal of the American Soci‑
ety for Information Science and Technology, 61(9), 1745–1770. https://doi.org/10.1002/
asi.21338
Manley, E., Concannon, D., & Gray, S. (2016, November 28). Africa Centre/I‑Sense. 
The Bartlett Centre for Advanced Spatial Analysis. https://www.ucl.ac.uk/bartlett/casa/
research/current‑projects/africa‑centrei‑sense
McCarty, W. (2003). Humanities computing. In Encyclopedia of Library and Information 
Science. Marcel Dekker.
Miles, J. (1946). Major adjectives in English poetry from Wyatt to Auden. University of 
California Press.
Milton, R., Buyuklieva, B., Hay, D., Hudson‑Smith, A., & Gray, S. (2018). Talking to 
GNOMEs: Exploring privacy and trust around internet of things devices in a public space. 
Extended Abstracts of the 2018 CHI Conference on Human Factors in Computing Sys‑
tems, 1–6. https://doi.org/10.1145/3170427.3188481
Nebbia, M., Cilio, F., & Bobomulloev, B. (2021). Spatial risk assessment and the protection 
of cultural heritage in southern Tajikistan. Journal of Cultural Heritage, 49, 183–196. 
https://doi.org/10.1016/j.culher.2021.01.012
Nyhan, J. (2023). Hidden and devalued feminized labour in the digital humanities: On the 
index Thomisticus project 1965–67. Routledge.
Nyhan, J., & Duke‑Williams, O. (2014). Joint and multi‑authored publication patterns in 
the digital humanities. Literary and Linguistic Computing, 29(3), 387–399. https://doi.
org/10.1093/llc/fqu018
Nyhan, J., & Flinn, A. (2016a). Computation and the humanities: Towards an oral history 
of digital humanities. Springer.
Nyhan, J., & Flinn, A. (2016b). So, into the Chopper it went: Gabriel Egan and Julianne 
Nyhan. In J. Nyhan & A. Flinn (Eds.), Computation and the humanities (pp.
 237–256). 
Springer International Publishing. https://doi.org/10.1007/978‑3‑319‑20170‑2_16
Nyhan, J., & Flinn, A. (2016c). 
They took a chance: Susan Hockey and Julianne Nyhan. In 
J. Nyhan & A. Flinn (Eds.), Computation and the humanities (pp. 87–97). Springer Inter‑
national Publishing. https://doi.org/10.1007/978‑3‑319‑20170‑2_6
Nyhan, J., & Passarotti, M. (2019). One origin of digital humanities: Fr Roberto Busa in his 
own wor
ds. https://doi.org/10.1007/978‑3‑030‑18313‑4
Nyhan, J., Terras, M., & Mahony, S. (2014). Digital humanities and integrative learning. In 
D. Blackshields, J. Cronin, B. Higgs, S. Kilcommins, M. McCarthy, & A. Ryan (Eds.), 
Integrative learning: International research and practice (pp.
 235–247). Routledge (18; 
Issue 18). http://www.routledge.com/books/details/9780415711074/
Pal, K., 
Avery, N., Boston, P., Campagnolo, A., De Stefani, C., Matheson‑Pollock, H., 
Panozzo, D., Payne, M., Schüller, C., Sanderson, C., Scott, C., Smith, P., Smither, R., 
Sorkine‑Hornung, O., Stewart, A., Stewart, E., Stewart, P., Terras, M., Walsh, B., … 
Weyrich, T. (2016). Digitally reconstructing the Great Parchment Book: 3D recovery 
of fire‑damaged historical documents. Digital scholarship in the humanities, fqw057. 
https://doi.org/10.1093/llc/fqw057
Risam, R. (2015). Beyond the margins: Intersectionality and the digital humanities. Digi‑
tal Humanities Quarterly, 9(2). http://www.digitalhumanities.org/dhq/vol/9/2/000208/  
000208.html

Development of digital humanities research and pedagogy at UCL 97
Risam, R., & Josephs, K. B. (Eds.). (2021). The Digital Black Atlantic . University of Min‑
nesota Press.
Rockwell, G. (2007, May 2). An alternate beginning to humanities computing? Theoretica.
Ca. http://theoreti.ca/?p=1608
Rørstad, K., & Aksnes, D. W. (2015). Publication rate expressed by age, gender and aca‑
demic position – A large‑scale analysis of Norwegian academic staf
f. Journal of Informet‑
rics, 9(2), 317–333. https://doi.org/10.1016/j.joi.2015.02.003
Russell, D. B. (1965). COCOA  — A word‑count and concordance generator. Chilton 
Computing and UKRI 
Science and Technology Facilities Council. http://www.chilton‑  
computing.org.uk/acl/applications/cocoa/p001.htm
Sheppard, L., Reades, J., & Freeman, R. P. J. (2023). Gendering and diversifying the re‑
search pipeline: A quantitative feminist geographical approach to gender in higher educa‑
tion. Annals of the American Association of Geographers, 113(4), 817–833. https://doi.or
g/10.1080/24694452.2022.2160302
Shiode, N., Batty, M., Dodge, M., Jiang, B., & Thurstain‑Goodwin, M. (1998). The cen‑
tre for advanced spatial analysis and its projects on geographic information systems and 
urban analysis. Theory and Applications of GIS, 6(1), 81–86. https://doi.org/10.5638/
thagis.6.81
Spence, P. J., & Brandao, R. (2021). Towards language sensitivity and diversity in the digi‑
tal humanities. Digital Studies / Le Champ Numérique, 11(1). https://doi.org/10.16995/
dscn.8098
Sugimoto, C. R., Ni, C., West, J. D., & Larivière, V . (2015). The academic advantage: Gen‑
der disparities in patenting. PLoS ONE, 10(5), e0128000. https://doi.org/10.1371/journal.
pone.0128000
Terras, M. (2012, January 20). Infographic: Quantifying digital humanities. UCL DH Blog. 
http://blogs.ucl.ac.uk/dh/2012/01/20/infographic‑quantifying‑digital‑humanities/
Terras, M., Amman, R., & Gray, S. (2013). Textal: A text analysis smartphone app for digi‑
tal humanities. Journal of Digital Humanities, 2(3). https://journalofdigitalhumanities.
org/2‑3/textal‑a‑text‑analysis‑smartphone‑app‑for‑digital‑humanities/
Terras, M., Baker, J., Hetherington, J., Beavan, D., Zaltz Austwick, M., Welsh, A., O’Neill, 
H., Finley, W., Duke‑Williams, O., & Farquhar, A. (2018). Enabling complex analysis of 
large‑scale digital collections: Humanities research, high‑performance computing, and 
transforming access to British Library digital collections. Digital Scholarship in the Hu‑
manities, 33(2), 456–466. https://doi.org/10.1093/llc/fqx020
Terras, M. M. (2010, July 30). Announcing the new MA/MSc in digital humanities at  
UCL. UCLDH Blog. https://blogs.ucl.ac.uk/dh/2010/07/30/announcing‑the‑new‑mamsc‑in‑ 
digital‑humanities‑at‑ucl/
Terras, M. M., Nyhan, J., & Vanhoutte, E. (Eds.). (2013). Defining digital humanities: A 
reader. Ashgate Publishing Limited.
Thaller, M. (2017). Geschichte der digital humanities. In F. Jannidis, H. Kohle, & M. 
Rehbein (Eds.), Digital humanities (pp.
 3–12). J.B. Metzler. https://doi.org/10.1007/
 
978‑3‑476‑05446‑3_1
The ICE. (2021). The International Corpus of English (ICE). Retrieved from https://www.
ucl.ac.uk/english‑usage/projects/ice.htm
Times. (2022, April 3). Impact rankings: Gender equality. Times Higher Education (THE). 
https://www.timeshighereducation.com/rankings/impact/2022/gender‑equality
Tomlinson, R. F. (1974). Geographical information systems, spatial data analysis and deci‑
sion making in government [Doctoral thesis, University of London]. https://discovery.ucl.
ac.uk/id/eprint/1563584/

98 Jin Gao et al.
UCL. (2005). LAIRAH: Log analysis of internet resources in the arts and humanities. https://
www.ucl.ac.uk/infostudies/LAIRAH/
UCL. (2008a). About us. UCL Grand Challenges. https://www.ucl.ac.uk/grand‑challenges/
about‑us
UCL. (2008b). (VERA) Virtual Environments for Research in Archaeology . https://web.
archive.org/web/20140728122248/http://www.jisc.ac.uk/whatwedo/programmes/vre2/
vera.aspx
UCL. (2022). UCL Survey of English Usage. https://www.ucl.ac.uk/english‑usage/
...
the potential of non‑fungible tokens (NFTs). Applied Sciences, 11(21), 9931. https://doi.
org/10.3390/app11219931
Wang, X., & Inaba, M. (2009). Analyzing structures and evolution of digital humanities 
based on correspondence analysis and co‑word analysis. Art Research, 9, 123–134.
Warwick, C., Mahony, S., Nyhan, J., Ross, C., Terras, M., Tiedau, U., & Welsh, A. (2011). 
UCLDH: Big tent digital humanities in practice. Digital Humanities 2011 Conference 
Abstracts, 387–389.
Warwick, C., Terras, M., & Nyhan, J. (2012). Digital humanities in practice . Facet 
Publishing.
Watson, E., Eddo‑Lodge, R., & Solnit, R. (2022, April 6). City of Women London. The Bar‑
tlett Centre for Advanced Spatial Analysis. https://www.ucl.ac.uk/bartlett/casa/research/
current‑projects/city‑women‑london
Weingart, S. B., & Eichmann‑Kalwara, N. (2017). What’s under the big tent?: A study of 
ADHO conference abstracts. Digital Studies/Le Champ Numérique, 7(1). https://doi.
org/10.16995/dscn.284
Weingart, S. B., Eichmann‑Kalwara, N., & Lincoln, M. (2023). The Index of Digital Human-
ities Conferences Data [dataset]. Carnegie Mellon University. https://doi.org/10.1184/
R1/12987959.v4
Zaagsma, G. (2013). On digital history. BMGN
 – Low Countries Historical Review, 128(4), 
3. https://doi.or
g/10.18352/bmgn‑lchr.9344
Zhang, M. (2019, April 17). Palace Museum to launch new mobile app with informative 
features. CGTN Culture China. https://news.cgtn.com/news/3d3d414e3267444d34457a
6333566d54/index.html
