...
url: https://doi.org/10.4018/jswis.2013010101
last_enrichment_run: 2025-08-20
updated: 2025-08-20
tags:
  - Tech/KG/interactive_kg
  - Tech/KG/semanticData
  - design/UX/interaction
  - design/UX/interactionPatterns
  - Tech/software_semantic
apa_citation: Josep Maria Brunetti et al., 2013
---
[[Clippings/PDF/From Overview to Facets and Pivoting for Interactive Exploration of Semantic Web Data.pdf]]
...
Dadzie and Rowe (2011) present the most exhaustive and comprehensive survey to date of existing approaches to visualising and exploring Semantic Web data, particularly Linked Data. This survey is used to situate our contribution, implemented in a tool called Rhizomer and available online<sup>2</sup>. #op/acc/buscar #Tech/KG/semanticData #Tech/KG/linked_open_data

[Continue Reading](https://www.igi-global.com/gateway/article/full-text-html/77822)

## References #op/acc/buscar faceted exploration

| #op/acc/buscar | Araújo, F. C. S., Schwabe, D., & Barbosa, D. J. S. (2009). Explorator: A tool for exploring RDF data through direct manipulation. In *Proceedings of the Linked Data on the Web Workshop (LDOW 2009)* (Vol. 538, pp. 1613–1673). Madrid, Spain: CEUR Workshop Proceedings. #design/UCD/UCDMethod |
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| #op/acc/buscar | Bizer C. Heath T. Berners-Lee T. (2009). Linked data - The story so far.International Journal on Semantic Web and Information Systems, 5(3), 1–22. 10.4018/jswis.2009081901 #Tech/KG/semanticData #research_method/ScopingReview |
...
| #op/acc/buscar | García R. Gimeno J. M. Perdrix F. Gil R. Oliva M. López J. M. ==(2010)==. Building a usable and accessible semantic web interaction platform.World Wide Web (Bussum), 13, 143–167. 10.1007/s11280-009-0076-2 #design/UCD/UCDMethod #design/UX/usability |
| #op/acc/buscar | Garrett J. J. (2010). The elements of user experience: User-centered design for the web and beyond #op/acc/buscar (2nd ed.). Indianapolis, IN: New Riders. |
| #op/acc/buscar | Goldberg J. H. Helfman J. I. (2005). Enterprise network monitoring using treemaps.Proceedings of the Human Factors and Ergonomics Society, 49(5), 671–675. 10.1177/154193120504900508 |
| | Hearst, M. A. (2006). Design recommendations for hierarchical faceted search interfaces. In *Proceedings of the ACM SIGIR Workshop on Faceted Search**.* #op/acc/buscar |
...
| #op/acc/buscar | Heim, P., Ziegler, J., & Lohmann, S. (2008). gFacet: A browser for the web of data. In S. Auer, S. Dietzold, S. Lohmann, & J. Ziegler (Eds.), #op/acc/buscar *Proceedings of the International Workshop on Interacting with Multimedia Content in the Social Semantic Web (IMC-SSW’08)* (pp. 49–58). CEUR-WS. |
...
| #op/acc/buscar | Pietriga, E. (2006). Semantic web data visualization with graph style sheets. In *Proceedings of the 2006 ACM Symposium on Software Visualization (SoftVis ’06)* (pp. 177–178). New York, NY: ACM Press. #Tech/KG/semanticData |
...
| | Zhou, D. X., Oostendorp, N., Hess, M., & Resnick, P. (2008). Conversation pivots and double pivots. In *Proceedings of the SIGCHI Conference on Human Factors in Computing Systems (CHI’08)* (pp. 1009-1012). New York, NY: ACM Press. |
