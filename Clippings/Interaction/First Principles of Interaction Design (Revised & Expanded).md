...
authors: "[[Bruce Tognazzini]]"
published: 2014-03-06
created: 2026-02-13
description: "The following principles are fundamental to the design and implementation of effective interfaces, whether for traditional GUI environments, the web, mobile devices, wearables, or Internet-connecte…"
tags:
DOI:
Type:
year:
...
This revision features new examples and discussion involving mobile, wearables, and Internet-connected smart devices. However, the naming and organization remains the same except for three changes: I have shortened the name of one principle to extend its reach: “Color Blindness” is now simply [Color](https://asktog.com/atc/principles-of-interaction-design/#color) and includes more than just color blindness. I’ve added one new principle, [Aesthetics](https://asktog.com/atc/principles-of-interaction-design/#aesthetics), and brought back two old principles, [Discoverability](https://asktog.com/atc/principles-of-interaction-design/#discoverability) and [Simplicity](https://asktog.com/atc/principles-of-interaction-design/#simplicity). I dropped them from the list more than a decade ago when they had ceased to be a problem. Problems with Discoverability, in particular, have come roaring back.
...
| - [Belarusian](http://www.fatcow.com/edu/designedtogivefitts-be/) - [Dutch](http://aifia.org/nl/translations/000187.html) - [English](http://asktog.com/basics/firstPrinciplesOldEdition.html) | - [German](http://meiert.com/de/publications/translations/asktog.com/firstprinciples/) - [Italian](http://www.10people.net/tutorial/interaction_design-ask_tog/pricipi_di_interaction_design.html) - [Portuguese](http://userdesign.org/principios.html) | - [Spanish](http://galinus.com/es/articulos/principios-diseno-de-interaccion.html) - [Russian](http://ashapiro.ru/translations/tog-first-principles/) - [Ukrainian](http://www.portablecomponentsforall.com/edu/designedtogivefitts-uk/) |
| --- | --- | --- |
...
- **Principle: Fashion should never trump usabilit** y
...
[Top](https://asktog.com/atc/principles-of-interaction-design/#)
...
• **Platform consistency:** Be generally consistent with [*de jure* As dictated by guidelines and standards](https://asktog.com/atc/principles-of-interaction-design/#) & [*de facto* The unwritten rules to which the community adheres.](https://asktog.com/atc/principles-of-interaction-design/#) standards
...
Apple apparently thought this was a good idea and started copying Microsoft by adding invisible controls from scroll bars to buttons everywhere. The situation on the Mac got so bad that, by the early 2010s, the only way a user could discover how to use many of the most fundamental features of the computer was to use Google to search for help. (For more, see: [Discoverability](https://asktog.com/atc/principles-of-interaction-design/#discoverability))
...
Making a complex control like the scroll bar invisible likewise slows the user attempting to actually scroll: With the scroll invisible, the user can’t predict where in the blank space hiding the control she should scrub in order to find herself over the “elevator” she will use to do the scrolling. Instead, she first has to scrub somewhere in the scroll bar (target one) and then slide up or down to the elevator (target 2). (See [Fitts’s Law](https://asktog.com/atc/principles-of-interaction-design/#fittsLaw) for why this is bad.) Let’s assume that extra step would only require one extra second, a very conservative estimate. One second lost X ten scrolls per day per person X 66 million Mac users (at the time of this writing) = 21 person-years of wasted life and productivity per day, all to make a screen in a store look simpler.
...
Many other principles in this list affect efficiency, [Latency Reduction](https://asktog.com/atc/principles-of-interaction-design/#latencyReduction) and [Readability](https://asktog.com/atc/principles-of-interaction-design/#readability) in particular.
...
Users should be able to log off at work, go home, and take up exactly where they left off. Following the principle of [Protect Users’ Work](https://asktog.com/atc/principles-of-interaction-design/#protectUsersWork), whatever they were last working on should be preserved in its current condition.
...
(See also: [Discoverability](https://asktog.com/atc/principles-of-interaction-design/#discoverability))
...
[NN/g Home](http://www.nngroup.com/index.html) [AskTog](http://www.asktog.com/index.html) [Interaction Design Section](http://www.asktog.com/menus/designMenu.html)

to help them build a mental model. As with the inherent statelessness of the web (see [Track State](https://asktog.com/atc/principles-of-interaction-design/#trackState), above), we must go beyond blindly accepting what the web’s architects have given us by adding layers of capability and protection that users want and need. That the web’s navigation is inherently invisible is a challenge, not an inevitability.
...
[Providing Predictable Targets](https://asktog.com/atc/providing-predictable-targets/)
