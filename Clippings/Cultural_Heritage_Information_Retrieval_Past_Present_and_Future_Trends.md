...
pages: 42992-43026
updated: 2025-08-20
url: https://ieeexplore.ieee.org/ielx7/6287639/6514899/10463018.pdf
volume: 12
apa_citation: Babak Ranjgar et al., 2024
---

[[Cultural Heritage Information Retrieval - Past, Present, and Future Trends.pdf]]
...
type: document
base: clippings
arxiv_id: document/1046301
url: https://arxiv.org/abs/document/1046301
last_enrichment_run: 2025-01-20
updated: 2025-01-20
---
...
Digital Object Identifier 10.1 109/ACCESS.2024.3374769
Cultural Heritage Information Retrieval:
Past, Present, and Future Trends
BABAK RANJGAR
 1, ABOLGHASEM SADEGHI-NIARAKI2,3, (Member, IEEE),
MARYAM SHAKERI4, FATEMA RAHIMI2,3, AND SOO-MI CHOI
2,3, (Member, IEEE)
...
INDEX TERMSCultural heritage, data modeling, semantic web, information retrieval, ontology, knowledge
...
which is solved by the decentralized architecture of the
...
standards and knowledge management in the cultural heritage
...
VOLUME 12, 2024 42993

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
review of the vast topic of information retrieval and semantic
...
Classification Systems, Controlled V ocabulary, Thesaurus,
...
knowledge organization through Semantic Web technologies.
...
The Semantic Web and its technologies were started to handle
the previously mentioned issues. The initial recommendation
of the Semantic Web was to use metadata schemas to describe
...
The library of congress classification (LCC 2) Is another
...
content [31]. V ocabulary control is used to standardize the
...
designated name [7]. Examples of such lists are the LCNAF 4
...
VOLUME 12, 2024 42995

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
this group formed the VIAF 5 (Virtual International Authority
File) consortium at the 69 th IFLA (International Federation of
...
The Glossary of Archives and Records Terminology 6 of the
Society of American Archivists (SAA) and the Glossary of
the Rules for Archival Description 7 are examples of these
types of lists.
...
descriptive information. the gazetteer of british place names 8
and the world-historical gazetteer 9 are two examples of many
...
level thesaurus. for example, the UKAT 11 (United Kingdom
5https://viaf.org/
...
with indexing their collections and catalogs. The LCSH 12
...
by the getty institute. the getty vocabularies 13 (AAT, TGN,
...
to museum collections, special collections, archives, libraries,
...
42996 VOLUME 12, 2024

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
data exchange with minimal loss of content and functionality
...
CAN/MARC). It was named MARC21 because it was refined
for the 21 st century and to make it more accessible to the
international community. Later, it adopted an XML markup
language and developed MARCXML 15 in order to facilitate
the sharing of and the networked access to bibliographic
information. The Library of Congress’ Network Develop-
ment and the MARC Standard Office developed MODS 16
...
DC and its mapping is more convenient. MADS 17 (Metadata
...
exchanging information about archival data. MARC AMC 20
(MARC for Archives and Manuscripts Control) metadata was
...
for archival finding aids. The EAD 21 (Encoded Archival
...
VOLUME 12, 2024 42999

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
and address challenges associated with metadata integration,
...
43000 VOLUME 12, 2024

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
more general to more specific. An ontology is left for open
...
result of the activities was the CIDOC Relational Data Model,
...
community.
The task was achieved in 2006 since the CIDOC CRM was
...
formal definitions for CRM were developed in TELLOS, KIF,
...
only data model that is an ISO standard in the CH domain, and
...
VOLUME 12, 2024 43001

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
the new phenomenon observed and specialized for user needs.
...
Time V olume (SPV) concept. Details can be found in [67]
...
43002 VOLUME 12, 2024

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
to small-scale ones. In the ARIADNE project, CRM was
...
this matter it used a simplified form of CRM [72]. The WissKI
...
spatial data and analysis and also uses CIDOC CRM to model
...
the information [76].
In Korea, KCHDM (Korean Cultural Heritage Data Model)
...
general shortcomings in metadata schemas. The model reuses
...
Spanish, as well as English textbooks and reference materials.
...
were some of the data models developed in the CH domain for
...
VOLUME 12, 2024 43003

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
types of activities, the data models became more and more
...
especially CIDOC CRM, which is a well-established standard
...
into the taxonomy and ontology management software. In this
...
the process the two different modeling methods are discussed.
...
VOLUME 12, 2024 43005

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
event-centric method allows for a quite normal way of sharing
...
same entity are gathered to provide multiple views for a single
...
43006 VOLUME 12, 2024

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
Web, is arranged to make the Belliniano Museum’s history
...
VOLUME 12, 2024 43007

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
and/or Sitemaps. These investigations were carried out in
...
43008 VOLUME 12, 2024

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
system, BiographySampo and AcademySampo, is based on
...
program produced Mapping Manuscript Migrations (MMM).
...
help of Semantic Web technologies and standards. Europeana
...
the data provided by APIs. The Europeana portal is developed
...
search. Z39.50 26 is amongst the first protocols developed
...
HTTP protocol and REST. SRU has a twin protocol SRW 28
...
data to find other related data [121]. Linked Data employs two
...
Data in 2007 supported by the W3C Semantic Web Education
27http://www.loc.gov/standards/sru/
28http://www.loc.gov/standards/sru/companionSpecs/srw.html
29https://www.openarchives.org/pmh/
VOLUME 12, 2024 43009

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
and Outreach Working Group (SWEO). The intention behind
...
things we refer to are within these two. DBpedia 30 extracts
...
By following the idea of this project, the Amsterdam Museum
...
43010 VOLUME 12, 2024

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
Linked Data blog [WR26]. SEG 3.0 is an approach that
...
prediction model that would aid in the preservation of cultural
...
VOLUME 12, 2024 43011

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
proposed methodology was created as part of the ChIA
...
Besides the functions mentioned above, the information in the
...
thesauri in contrast to other projects, such as MuseumFinland,
which mapped the entire data to a single schema. /facet was
developed as a part of the Netherlands MultimediaN e-culture
project.
...
• Concept satisfiability which is to check whether a newly
...
43012 VOLUME 12, 2024

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
• Proper instantiation that is to check whether a given
...
concept-based modeling of OWL prevents it from performing
...
RuleML sublanguages of the Rule Markup Language. SWRL
...
in OWL language using Protégé 40 software. Since the CRM
...
VOLUME 12, 2024 43013

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
FIGURE 5. The evolution of the concept of CH visualization across
time [156].
...
2001 was the start in the CH domain [157]. Visual multimedia
...
process in a museum more interactive than just reading labels
...
43014 VOLUME 12, 2024

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
technologies provide the services that they are designed for.
...
the data, the actual reuse of it is the missing part [174]. It is not
...
solved largely with various kinds of data models and metadata
...
43016 VOLUME 12, 2024

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
of heterogeneous data sources, semantic interoperability, and
...
keeping with ethical responsibility to society. the construction
...
quantified in terms of new modern forms of culture that it aids
...
VOLUME 12, 2024 43017

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
• Enabling large-scale cooperation and fostering cir-
...
With the emergence of web and web services, gis systems also
...
architectural heritage buildings in multilevel views from LOD
...
and architecture thesaurus) V ocabulary, so that the model is
...
reasoning and manipulation of 3d models for the management
...
43018 VOLUME 12, 2024

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
of information retrieval when processing a spatial query.
...
VOLUME 12, 2024 43019

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
The dynamic involvement of individuals in the CHH
...
industry.
ACKNOWLEDGMENT
(Babak Ranjgar and Abolghasem Sadeghi-Niaraki con-
tributed equally to this work.)
REFERENCES
[1] O. Signore, ‘‘Representing knowledge in archaeology: From cataloguing
cards to semantic web,’’ Archeologia E Calcolatori, vol. 20, pp. 111–128,
Jan. 2009.
[2] P. Ghosh, ‘‘Google’s vint cerf warns of ‘digital dark age,’’’ BBC
News, San Jose, CA, USA, Feb. 13, 2015. [Online]. Available:
https://www.bbc.com/news/science-environment-31450389
[3] A. C. Eberendu and M. University, ‘‘Unstructured data: An overview of
the data of big data,’’ Int. J. Comput. Trends Technol. , vol. 38, no. 1,
pp. 46–50, Aug. 2016.
[4] A. Masood and A. Hashmi, ‘‘Text analytics: The dark data frontier,’’ in
Cognitive Computing Recipes. Berkeley, CA, USA: Apress, 2019, doi:
10.1007/978-1-4842-4106-6_4.
[5] M. van Erp and V . de Boer, ‘‘A polyvocal and contextualised seman-
tic web,’’ in The Semantic Web. Berlin, Germany: Springer, 2021,
pp. 506–512.
[6] V . R. Benjamins, J. Contreras, M. Blàzquez, J. M. Dodero, A. Garcia,
E. Navas, F. Hernández, and C. Wert, ‘‘Cultural heritage and the semantic
web,’’ in The Semantic Web: Research and Applications, C. J. Bussler,
J. Davies, D. Fensel, and R. Studer, Eds. Berlin, Germany: Springer, 2004,
pp. 433–444.
43020 VOLUME 12, 2024

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
[7] G. Bruseker, N. Carboni, and A. Guillem, ‘‘Cultural heritage data
management: The role of formal ontology and CIDOC CRM,’’ in
Heritage and Archaeology in the Digital Age (Quantitative Methods in
the Humanities and Social Sciences), M. Vincent, V . L.-M. Bendicho,
M. Ioannides, and T. Levy, Eds. Cham, Switzerland: Springer, 2017,
pp. 93–131, doi: 10.1007/978-3-319-65370-9_6.
[8] T. Berners-Lee, J. Hendler, and O. Lassila, ‘‘The semantic web,’’
Sci. Amer., vol. 284, no. 5, pp. 34–43, 2001. [Online]. Available:
http://www.jstor.org/stable/26059207
[9] N. Shadbolt, T. Berners-Lee, and W. Hall, ‘‘The semantic web
revisited,’’IEEE Intell. Syst., vol. 21, no. 3, pp. 96–101, May 2006, doi:
10.1109/MIS.2006.62.
[10] S. Noor, L. Shah, M. Adil, N. Gohar, G. E. Saman, S. Jamil, and
F. Qayum, ‘‘Modeling and representation of built cultural heritage data
using semantic web technologies and building information model,’’
Comput. Math. Org. Theory, vol. 25, no. 3, pp. 247–270, Sep. 2019, doi:
10.1007/s10588-018-09285-y.
[11] M. Alam, V . de Boer, E. Daga, M. van Erp, E. Hyvönen, and
A. Meroño-Peñuela, ‘‘Editorial of special issue on cultural heritage and
semantic web technology,’’ Semantic Web—Interoperability, Usability,
Applicability, vol. 14, no. 2, pp. 155–158, 2022, doi: 10.3233/SW-
223187.
[12] E. Hyvonen, Publishing and Using Cultural Heritage Linked Data on the
Semantic Web. Berlin, Germany: Springer, 2022.
[13] S. Y . D. Bani Omar, ‘‘The significance of cultural heritage in fostering
economic viability,’’ Global J. Econ. Bus., vol. 12, no. 3, pp. 414–424,
Jun. 2022.
[14] M. B. Saydam, A. Ozturen, and C. Kilic, ‘‘Cultural heritage tourism
in north cyprus: Findings from in-depth interviews with experts,’’
Worldwide Hospitality Tourism Themes , vol. 14, no. 4, pp. 349–364,
Jul. 2022.
[15] W. M. W. Isa, N. A. M. Zin, F. Rosdi, and H. M. Sarim, ‘‘Digital
preservation of intangible cultural heritage,’’ Indonesian J. Elect. Eng.
Comput. Sci., vol. 12, no. 3, pp. 1373–1379, 2018.
[16] D. H. R. Spennemann, ‘‘The Nexus between cultural heritage manage-
ment and the mental health of urban communities,’’ Land, vol. 11, no. 2,
p. 304, Feb. 2022, doi: 10.3390/land11020304.
[17] K. Starčević, Ž. V ojinović, and J. Glavas, ‘‘Intangible cultural her-
itage and their influence on financial results in rural tourism,’’
Ekonomika Poljoprivrede, vol. 69, no. 2, pp. 483–496, Jun. 2022, doi:
10.5937/ekopolj2202483s.
[18] L. M. Al-Orainat, ‘‘The role of local residents in safeguarding cultural
heritage sites: Aqaba city, Jordan,’’ July Issue, vol. 11, no. 3, pp. 93–101,
Jul. 2022.
[19] Z. Qi, ‘‘Design of China’s intangible cultural heritage inheritance and
protection system based on intelligent media technology,’’ Proc. SPIE,
vol. 12703, Jun. 2023, Art. no. 127031Z, doi: 10.1117/12.2683105.
[20] S. Öztemiz, ‘‘Cultural heritage literacy: A survey of academics from
humanities and social sciences,’’ J. Librarianship Inf. Sci., vol. 52, no. 3,
pp. 818–831, Sep. 2020, doi: 10.1177/0961000619872529.
[21] T. Ocal, ‘‘The effect of field trips to historical cultural heritage sites on
teacher candidates’ academic knowledge and their sensitivity,’’ Creative
Educ., vol. 7, no. 2, pp. 376–386, 2016, doi: 10.4236/ce.2016.72037.
[22] K. N. Vavliakis, G. T. Karagiannis, and P. A. Mitkas, ‘‘Semantic web
in cultural heritage after 2020,’’ in Proc. 11th Int. Semantic Web Conf.,
Boston, MA, USA, 2012, pp. 11–15.
[23] I. Nishanbaev, E. Champion, and D. A. Mcmeekin, ‘‘A survey of
geospatial semantic web for cultural heritage,’’ Heritage, vol. 2, no. 2,
pp. 1471–1498, May 2019, doi: 10.3390/heritage2020093.
[24] X. Yang, P. Grussenmeyer, M. Koehl, H. Macher, A. Murtiyoso,
and T. Landes, ‘‘Review of built heritage modelling: Integration of
HBIM and other information techniques,’’ J. Cultural Heritage, vol. 46,
pp. 350–360, Nov. 2020, doi: 10.1016/j.culher.2020.05.008.
[25] E. Moraitou, Y . Christodoulou, and G. Caridakis, ‘‘Semantic models
and services for conservation and restoration of cultural heritage: A
comprehensive survey,’’ Semantic Web, vol. 14, no. 2, pp. 261–291,
Dec. 2022, doi: 10.3233/sw-223105.
[26] S. Desul, R. K. Mahapatra, R. K. Patra, M. Sethy, and N. Pandey, ‘‘Seman-
tic technology for cultural heritage: A bibliometric-based review,’’ Global
Knowl., Memory Commun., Aug. 2023, doi: 10.1108/gkmc-04-2023-
0125.
[27] M. T. Biagetti, ‘‘Ontologies as knowledge organization systems,’’ Knowl.
Org., vol. 48, no. 2, pp. 152–176, 2021.
[28] W. Z. Alma’aitah, A. Z. Talib, and M. A. Osman, ‘‘Opportunities
and challenges in enhancing access to metadata of cultural heritage
collections: A survey,’’ Artif. Intell. Rev., vol. 53, no. 5, pp. 3621–3646,
Jun. 2020, doi: 10.1007/s10462-019-09773-w.
[29] A. Salaba and L. M. Chan, Cataloging and Classification: An Introduc-
tion. Lanham, MD, USA: Rowman & Littlefield, 2023.
[30] D. R. Adhikari and P. Shrestha, ‘‘Knowledge management initiatives
for achieving sustainable development goal 4.7: Higher education
institutions’ stakeholder perspectives,’’ J. Knowl. Manag., vol. 27, no. 4,
pp. 1109–1139, Mar. 2023, doi: 10.1108/jkm-03-2022-0172.
[31] A. Sharma and S. Kumar, ‘‘Machine learning and ontology-based
novel semantic document indexing for information retrieval,’’
Comput. Ind. Eng., vol. 176, Feb. 2023, Art. no. 108940, doi:
10.1016/j.cie.2022.108940.
[32] M. Vállez, R. Pedraza-Jiménez, L. Codina, S. Blanco, and C. Rovira,
‘‘Updating controlled vocabularies by analysing query logs,’’ Online Inf.
Rev., vol. 39, no. 7, pp. 870–884, Nov. 2015, doi: 10.1108/oir-06-2015-
0180.
[33] Guidelines for the Construction, Format, and Management of Monolin-
gual Controlled Vocabularies, NISO Press, Baltimore, MD, USA, 2005.
[34] Z. Huang and L. Yuan, ‘‘Enhancing learning and exploratory search with
concept semantics in online healthcare knowledge management systems:
An interactive knowledge visualization approach,’’ Exp. Syst. Appl.,
vol. 237, Mar. 2024, Art. no. 121558, doi: 10.1016/j.eswa.2023.121558.
[35] M. Wu, S. M. Richard, C. Verhey, L. J. Castro, B. Cecconi, and
N. Juty, ‘‘An analysis of crosswalks from research data schemas to
Schema.org,’’ Data Intell., vol. 5, no. 1, pp. 100–121, Mar. 2023, doi:
10.1162/dint_a_00186.
[36] B. Pang, J. Gou, H. Afsarmanesh, W. Mu, and Z. Zhang, ‘‘Methodology
and mechanisms for federation of heterogeneous metadata sources and
ontology development in emerging collaborative environment,’’ VINE
J. Inf. Knowl. Manag. Syst., vol. 53, no. 1, pp. 80–99, Jan. 2023, doi:
10.1108/vjikms-09-2020-0159.
[37] M. van Ballegooie and W. Duff, ‘‘Archival metadata,’’ in DCC
Digital Curation Manual, S. Ross and M. Day, Eds. HATII, Uni-
versity of Glasgow; University of Edinburgh; UKOLN, University of
Bath; Council for the Central Laboratory of the Research Councils,
May 2006. [Online]. Available: http://www.dcc.ac.uk/resource/curation-
manual/chapters/archival-metadata
[38] U. Shah, T. Finin, A. Joshi, R. S. Cost, and J. Mayfield, ‘‘Information
retrieval on the semantic web,’’ in Proc. Int. Conf. Inf. Knowl. Manag.,
2002, pp. 461–468, doi: 10.1145/584792.584868.
[39] A. Isaac, S. Schlobach, H. Matthezing, and C. Zinn, ‘‘Integrated access
to cultural heritage resources through representation and alignment of
controlled vocabularies,’’ Library Rev., vol. 57, no. 3, pp. 187–199,
Mar. 2008, doi: 10.1108/00242530810865475.
[40] B. Haslhofer and W. Klas, ‘‘A survey of techniques for achieving metadata
interoperability,’’ACM Comput. Surv., vol. 42, no. 2, pp. 1–37, Mar. 2010,
doi: 10.1145/1667062.1667064.
[41] T. Ruotsalo and E. Hyvonen, ‘‘An event-based approach for semantic
metadata interoperability,’’ in Proc. Int. Semantic Web Conf. (Lecture
Notes in Computer Science), vol. 4825, 2007, pp. 409–422, doi:
10.1007/978-3-540-76298-0_30.
[42] A. Amato, ‘‘Towards the interoperability of metadata for cultural
heritage,’’ in Proc. Conf. Complex, Intell., Softw. Intensive Syst. (Lecture
Notes on Data Engineering and Communications Technologies), vol. 176,
2023, pp. 309–317, doi: 10.1007/978-3-031-35734-3_31.
[43] G. Schreiber, A. Amin, L. Aroyo, M. van Assem, V . de Boer,
L. Hardman, M. Hildebrand, B. Omelayenko, J. van Osenbruggen,
A. Tordai, J. Wielemaker, and B. Wielinga, ‘‘Semantic annotation and
search of cultural-heritage collections: The MultimediaN E-culture
demonstrator,’’J. Web Semantics, vol. 6, no. 4, pp. 243–249, Nov. 2008,
doi: 10.1016/j.websem.2008.08.001.
[44] S. Lim and C. Li Liew, ‘‘Metadata quality and interoperability of GLAM
digital images,’’ Aslib Proc., vol. 63, no. 5, pp. 484–498, Sep. 2011, doi:
10.1108/00012531111164978.
[45] M. O. Vakulenko, ‘‘Deep contextual disambiguation of homonyms
and polysemants,’’ Digit. Scholarship Humanities , vol. 38, no. 2,
pp. 772–778, May 2023, doi: 10.1093/llc/fqac081.
[46] R. Studer, V . R. Benjamins, and D. Fensel, ‘‘Knowledge engineering:
Principles and methods,’’ Data Knowl. Eng., vol. 25, nos. 1–2,
pp. 161–197, Mar. 1998, doi: 10.1016/s0169-023x(97)00056-6.
[47] M. Uschold and M. Gruninger, ‘‘Ontologies: Principles, methods and
applications,’’ Knowl. Eng. Rev., vol. 11, no. 2, pp. 93–136, Jun. 1996,
doi: 10.1017/s0269888900007797.
VOLUME 12, 2024 43021

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
[48] T. R. Gruber, ‘‘A translation approach to portable ontology specifica-
tions,’’ Knowl. Acquisition, vol. 5, no. 2, pp. 199–220, Jun. 1993, doi:
10.1006/knac.1993.1008.
[49] R. Davis, H. Shrobe, and P. Szolovits, ‘‘What is a knowledge
representation?’’ AI Mag., vol. 14, no. 1, p. 17, Mar. 1993, doi:
10.1609/AIMAG.V14I1.1029.
[50] P. Le Boeuf, M. Doerr, C. E. Ore, and S. Stead, ‘‘Definition of the
CIDOC conceptual reference model. version 6.2.3,’’ ICOM/CIDOC
Documentation Standards Group, 2018. [Online]. Available: https://w
ww.cidoc-crm.org/sites/default/files/2018-05-16%23CIDOC%20CRM_
v6.2.3_esIP%28XDP%29%28XM%29.pdf
[51] N. Guarino and C. Welty, ‘‘A formal ontology of properties,’’ in Proc. Int.
Conf. Knowl. Eng. Knowl. Manag. (Lecture Notes in Computer Science),
vol. 1937, 2000, pp. 97–112, doi: 10.1007/3-540-39967-4_8.
[52] G. Antoniou and F. van Harmelen, ‘‘Web ontology language: OWL,’’
in Handbook on Ontologies (International Handbooks on Information
Systems), S. Staab and R. Studer, Eds. Berlin, Germany: Springer, 2009,
pp. 91–110, doi: 10.1007/978-3-540-92673-3_4.
[53] M. Doerr, ‘‘The CIDOC conceptual reference module: An ontological
approach to semantic interoperability of metadata,’’ AI Mag, vol. 24,
no. 3, p. 75, Sep. 2003, doi: 10.1609/AIMAG.V24I3.1720.
[54] M. Doerr, ‘‘Ontologies for cultural heritage,’’ in Handbook on Ontologies
(International Handbooks on Information Systems), S. Staab and
R. Studer, Eds. Berlin, Germany: Springer, 2009, pp. 463–486, doi:
10.1007/978-3-540-92673-3_21.
[55] G. Goerz, M. Oischinger, and B. Schiemann, ‘‘An implementation of
the CIDOC conceptual reference model (4.2. 4) in OWL-DL,’’ in Proc.
Annual Conf. CIDOC Digit. Curation Cultural Heritage, 2008, pp. 1–14.
[56] C. Lagoze and J. Hunter, ‘‘The ABC ontology and model,’’ in Proc.
Int. Conf. Dublin Core Metadata Appl., Tokyo, Japan, Oct. 2001,
pp. 160–176.
[57] M. Doerr, J. Hunter, and C. Lagoze, ‘‘Towards a core ontology for
information integration,’’ J. Digit. Inf., vol. 4, no. 1, 2003.
[58] C. Bekiari. (Mar. 2017). Definition of FRBRoo: A Conceptual
Model for Bibliographic Information in Object-Oriented Formal-
ism. International Federation of Library Associations and Institutions
(IFLA). Accessed: Jan. 10, 2024. [Online]. Available: https://repository.
ifla.org/handle/123456789/659
[59] P. Le Boeuf and F.-X. Pelegrin, ‘‘FRBR and serials: The PRESSoo
model,’’ in Proc. IFLA WLIC, Lyon, France, Aug. 2014.
[60] M. Doerr and M. Theodoridou, ‘‘CRMdig: A generic digital provenance
model for scientific observation,’’ in Proc. 3rd USENIX Workshop Theory
Practice Provenance, 2011, pp. 1–5.
[61] O. Hartig, ‘‘Provenance information in the web of data,’’ LDOW, vol. 538,
Apr. 2009. [Online]. Available: https://citeseerx.ist.psu.edu/document?
repid=rep1&type=pdf&doi=610dfe308d51e2616cfbc72ac4841cdabd5a5
f0d
[62] M. Doerr, A. Kritsotaki, Y . Rousakis, G. Hiebel, and M. Theodoridou,
‘‘CRMsci: The scientific observation model,’’ FORTH, Tech. Rep., 2014.
[Online]. Available: https://projects.ics.forth.gr/isl/CRMext/CRMsci/
docs/CRMsci1.1.pdf
[63] S. Stead, M. Doerr, C.-E. Ore, and A. Kritsotaki, ‘‘CRMinf: The argumen-
tation model. An extension of CIDOC-CRM to support argumentation,’’
Paveprime Ltd, Tech. Rep., 2015. [Online]. Available: https://www.cidoc-
crm.org/crminf/sites/default/files/CRMinf%20ver%2010.1.pdf
[64] M. Doerr A. Felicetti, S. Hermon, G. Hiebel, A. Kritsotaki, A. Masur,
K. May, P. Ronzino, W. Schmidle, M. Theodoridou, and D. Tsiafaki,
‘‘Definition of the CRMarchaeo. Version 1.4.8,’’ PIN, Univ. Florence,
Italy, Tech. Rep., Feb. 2019. [Online]. Available: https://www.cidoc-
crm.org/crmarchaeo/sites/default/files/CRMarchaeo_v1.4.8.pdf
[65] P. Ronzino, F. Niccolucci, A. Felicetti, and M. Doerr, ‘‘CRMba a CRM
extension for the documentation of standing buildings,’’ Int. J. Digit.
Libraries, vol. 17, no. 1, pp. 71–78, Mar. 2016, doi: 10.1007/s00799-015-
0160-4.
[66] P. Ronzino, ‘‘Harmonizing the CRMba and CRMarchaeo models,’’
Int. J. Digit. Libraries, vol. 18, no. 4, pp. 253–261, Nov. 2017, doi:
10.1007/s00799-016-0193-3.
[67] M. Doerr, G. Hiebel, and O. Eide, ‘‘CRMgeo: Linking the CIDOC
CRM to GeoSPARQL through a spatiotemporal refinement,’’ Inst.
Comput. Sci., FORTH, Heraklion, Greece, Tech. Rep. ICS-FORTH/TR-
435, Apr. 2013. [Online]. Available: https://projects.ics.forth.gr/tech-
reports/2013/2013.TR435_CRMgeo_CIDOC_CRM_GeoSPARQL.pdf
[68] G. Hiebel, M. Doerr, and Ø. Eide, ‘‘CRMgeo: A spatiotemporal extension
of CIDOC-CRM,’’ Int. J. Digit. Libraries, vol. 18, no. 4, pp. 271–279,
Nov. 2017, doi: 10.1007/s00799-016-0192-4.
[69] M. Theodoridou, G. Bruseker, M. Daskalaki, and M. Doerr, ‘‘Method-
ological tips for mappings to CIDOC CRM,’’ in Proc. 44th Conf. Comput.
Appl. Quant. Methods Archaeology, 2016, pp. 89–102.
[70] M. Van Ruymbeke, P. Hallot, G.-A. Nys, and R. Billen, ‘‘Implementation
of multiple interpretation data model concepts in CIDOC CRM and
compatible models,’’ Virtual Archaeol. Rev., vol. 9, no. 19, pp. 50–65,
Jul. 2018, doi: 10.4995/var.2018.8884.
[71] C. Meghini, R. Scopigno, J. Richards, H. Wright, G. Geser, S. Cuy,
J. Fihn, B. Fanini, H. Hollander, F. Niccolucci, A. Felicetti, P. Ronzino,
F. Nurra, C. Papatheodorou, D. Gavrilis, M. Theodoridou, M. Doerr,
D. Tudhope, C. Binding, and A. Vlachidis, ‘‘ARIADNE,’’ J. Com-
put. Cultural Heritage, vol. 10, no. 3, pp. 1–27, Aug. 2017, doi:
10.1145/3064527.
[72] D. Oldman and D. Tanase, ‘‘Reshaping the knowledge graph by
connecting researchers, data and practices in researchspace,’’ in Proc. Int.
Semantic Web Conf. (Lecture Notes in Computer Science), vol. 11137,
2018, pp. 325–340, doi: 10.1007/978-3-030-00668-6_20.
[73] M. Scholz and G. Goerz, ‘‘WissKI: A virtual research environment for
cultural heritage,’’ Frontiers Artif. Intell. Appl., vol. 242, pp. 1017–1018,
Jan. 2012, doi: 10.3233/978-1-61499-098-7-1017.
[74] D. Myers, A. Dalgity, I. Avramides, and D. Wuthrich, ‘‘Arches: An
open source GIS for the inventory and management of immovable
cultural heritage,’’ in Proc. Euro-Mediterranean Conf. (Lecture Notes in
Computer Science), vol. 7616, 2012, pp. 817–824, doi: 10.1007/978-3-
642-34234-9_87.
[75] P. Cripps, A. Greenhalgh, D. Fellows, K. May, and D. Robinson,
‘‘Ontological modelling of the work of the centre for archaeology,’’
Tech. Rep., 2004. [Online]. Available: https://cidoc-crm.org/sites/
default/files/Documents/Ontological_Modelling_Project_Report_%20S
ep2004.pdf
[76] C. Binding, K. May, and D. Tudhope, ‘‘Semantic interoperability in
archaeological datasets: Data mapping and extraction via the CIDOC
CRM,’’ in Proc. Int. Conf. Theory Practice Digital Libraries (Lecture
Notes in Computer Science), vol. 5173, 2008, pp. 280–290, doi:
10.1007/978-3-540-87599-4_30.
[77] S. Kim, J. Ahn, J. Suh, H. Kim, and J. Kim, ‘‘Towards a semantic
data infrastructure for heterogeneous cultural heritage data—Challenges
of Korean cultural heritage data model (KCHDM),’’ in Proc. Dig-
ital Heritage Int. Congr., Digit. Heritage, 2015, pp. 275–282, doi:
10.1109/DIGITALHERITAGE.2015.7419508.
[78] E. Hyvonen, K. Viljanen, J. Tuominen, and K. Seppala, ‘‘Building a
national semantic web ontology and ontology service infrastructure—The
FinnONTO approach,’’ in Proc. Eur. Semantic Web Conf. (Lecture Notes
in Computer Science), vol. 5021, 2008, pp. 95–109, doi: 10.1007/978-3-
540-68234-9_10.
[79] E. Mäkelä, E. Hyvönen, and T. Ruotsalo, ‘‘How to deal with
massively heterogeneous cultural heritage data—Lessons learned in
CultureSampo,’’ Semantic Web, vol. 3, no. 1, pp. 85–109, 2012, doi:
10.3233/sw-2012-0049.
[80] M. Doerr, S. Gradmann, S. Hennicke, A. Isaac, C. Meghini, and
H. Van de Sompel, ‘‘The Europeana data model (EDM),’’ in Proc. World
Library Inf. Congr., 76th IFLA General Conf. Assembly, vol. 2010,
p. 15.
[81] R. Cacciotti, J. Valach, P. Kunes, M. Cernanský, M. Blasko, and
P. Kremen, ‘‘Monument damage information system (MONDIS):
An ontological approach to cultural heritage documentation,’’ ISPRS
Ann. Photogramm., Remote Sens. Spatial Inf. Sci., vols. 5, pp. 55–60,
Jul. 2013, doi: 10.5194/isprsannals-ii-5-w1-55-2013.
[82] T. Hellmund, P. Hertweck, D. Hilbring, J. Mossgraber, G. Alexandrakis,
P. Pouli, A. Siatou, and G. Padeletti, ‘‘Introducing the HERACLES
ontology—Semantics for cultural heritage management,’’ Heritage,
vol. 1, no. 2, pp. 377–391, Nov. 2018, doi: 10.3390/heritage1020026.
[83] M. A. Musen, ‘‘The protégé project: A look back and a look forward,’’ AI
Matters, vol. 1, no. 4, pp. 4–12, Jun. 2015.
[84] B. Almeida and R. Costa, ‘‘OntoAndalus: An ontology of Islamic
artefacts for terminological purposes,’’ Semantic Web, vol. 12, no. 2,
pp. 295–311, Jan. 2021, doi: 10.3233/sw-200387.
[85] D. Liu, A. Bikakis, and A. Vlachidis, ‘‘Evaluation of semantic web
ontologies for modelling art collections,’’ Commun. Comput. Inf. Sci.,
vol. 767, pp. 343–352, 2017, doi: 10.1007/978-3-319-67162-8_34.
43022 VOLUME 12, 2024

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
[86] A. Origlia, S. Rossi, S. D. Martino, F. Cutugno, and M. L. Chiacchio,
‘‘Multiple-source data collection and processing into a graph database
supporting cultural heritage applications,’’ J. Comput. Cultural Heritage,
vol. 14, no. 4, pp. 1–27, Jul. 2021, doi: 10.1145/3465741.
[87] J. Webber, ‘‘A programmatic introduction to Neo4J,’’ in Proc. 3rd Annu.
Conf. Syst., Program., Appl., Softw. Humanity, 2012, pp. 217–218, doi:
10.1145/2384716.2384777.
[88] F. Dietze, J. Karoff, A. C. Valdez, M. Ziefle, C. Greven, and U. Schroeder,
‘‘An open-source object-graph-mapping framework for Neo4j and Scala:
Renesca,’’ in Proc. Int. Conf. Availability, Rel., Secur. (Lecture Notes in
Computer Science), vol. 9817, 2016, pp. 204–218, doi: 10.1007/978-3-
319-45507-5_14.
[89] G. Drakopoulos, A. Kanavos, C. Makris, and V . Megalooikonomou,
‘‘On converting community detection algorithms for fuzzy graphs in
Neo4j,’’ 2016, arXiv:1608.02235.
[90] P. Jiménez, J. V . Diez, and J. Ordieres-Mere, ‘‘HOSHIN KANRI
visualization with Neo4j. Empowering leaders to operationalize lean
structural networks,’’ Proc. CIRP, vol. 55, pp. 284–289, Jan. 2016, doi:
10.1016/j.procir.2016.08.023.
[91] M. Falcone, A. Origlia, M. Campi, and S. Di Martino, ‘‘From architectural
survey to continuous monitoring: Graph-based data management for cul-
tural heritage conservation with digital twins,’’ Int. Arch. Photogramm.,
Remote Sens. Spatial Inf. Sci., vol. 4, pp. 47–53, Jun. 2021, doi:
10.5194/isprs-archives-xliii-b4-2021-47-2021.
[92] N. Rodionov, ‘‘Towards knowledge management system for DevOps:
Design research of the architectural concept,’’ M.S. thesis, Univ.
Neuchâtel, Neuchâtel, Switzerland, Jan. 2021.
[93] T. Schandl and A. Blumauer, ‘‘PoolParty: SKOS thesaurus management
utilizing linked data,’’ in Proc. Extended Semantic Web Conf. (Lecture
Notes in Computer Science), vol. 6089, 2010, pp. 421–425, doi:
10.1007/978-3-642-13489-0_36.
[94] D. V os, S. Heeren, N. van Ruler, K. Smallenbroek, and R. Lassche,
‘‘PAN (portable antiquities of The Netherlands): Harnessing geospatial
technology for the enrichment of archaeological data,’’ J. Geographic
Inf. Sci., vol. 6, no. 2, pp. 13–20, 2018, doi: 10.1553/giscience2018_
02_s13.
[95] B. Kasenchak, A. Lehnert, and G. Loh, ‘‘Use case: Ontologies and RDF-
star for knowledge management,’’ in Proc. Eur. Semantic Web Conf.
(Lecture Notes in Computer Science), vol. 12739, 2021, pp. 254–260,
doi: 10.1007/978-3-030-80418-3_38.
[96] F. Liu, J. Hindmarch, and M. Hess, ‘‘A review of the cultural heritage
linked open data ontologies and models,’’ Int. Arch. Photogramm.,
Remote Sens. Spatial Inf. Sci., vol. 2, pp. 943–950, Jun. 2023, doi:
10.5194/isprs-archives-xlviii-m-2-2023-943-2023.
[97] C. Dijkshoorn, L. Aroyo, J. van Ossenbruggen, and G. Schreiber,
‘‘Modeling cultural heritage data for online publication,’’ Appl.
Ontol., vol. 13, no. 4, pp. 255–271, Nov. 2018, doi: 10.3233/ao-
180201.
[98] C. Kakali, I. Lourdi, T. Stasinopoulou, L. Bountouri, C. Papatheodorou,
M. Doerr, and M. Gergatsoulis, ‘‘Integrating Dublin core metadata for
cultural heritage collections using ontologies,’’ in Proc. Int. Conf. Dublin
Core Metadata Appl., Aug. 2007, pp. 128–139. [Online]. Available:
https://dcpapers.dublincore.org/pubs/article/view/871
[99] K. Giri, ‘‘Role of ontology in semantic web,’’ DESIDOC J. Library Inf.
Technol., vol. 31, no. 2, pp. pp. 116–120, 2011.
[100] S. Cristofaro and D. Spampinato, ‘‘OntoBellini: Towards an RDA based
ontology for Vincenzo Bellini’s cultural heritage,’’ in Proc. JOWO, 2019,
pp. 1–6.
[101] M. Kreislere and I. Virbule, ‘‘The development of library sector
terminology in Latvia and problems and solutions for translating RDA
standard terms,’’ Terminologija, vol. 28, pp. 80–99, Dec. 2021, doi:
10.35321/term28-04.
[102] D. P. Ducheva and D. R. Pennington, ‘‘Resource description and access
in Europe: Implementations and perceptions,’’ J. Librarianship Inf. Sci.,
vol. 51, no. 2, pp. 387–402, May 2017, doi: 10.1177/0961000617709060.
[103] A. Rašmane and A. Goldberga, ‘‘The potential of IFLA LRM
and RDA key entities for identification of entities in textual docu-
ments of cultural heritage: The RunA collection,’’ Cataloging Clas-
sification Quart., vol. 58, no. 8, pp. 705–727, Nov. 2020, doi:
10.1080/01639374.2020.1862380.
[104] F. Leresche, ‘‘Libraries and archives: Sharing standards to facilitate
access to cultural heritage,’’ in Proc. World Library Inf. Congr., 74th IFLA
General Conf. Council, 2008, pp. 10–14.
[105] C. Bianchini and P. Zappalá, ‘‘ISBD and mechanical musical devices:
A case study of the department of musicology and cultural heritage,
University of Pavia, Italy,’’ Cataloging Classification Quart., vol. 52,
no. 8, pp. 940–960, Nov. 2014, doi: 10.1080/01639374.2014.921659.
[106] V . Tzouvaras, J. P. Evain, N. Simou, and A. Drosopoulos, ‘‘Linked
television heritage,’’inProc. 2nd Int. ACM Workshop Personalized Access
Cultural Heritage, 2012, pp. 1–5, doi: 10.1145/2390867.2390869.
[107] Space Data and Information Transfer Systems-Open Archival Informa-
tion System-Reference Model, Standard 14721, 2003.
[108] J. Spence, ‘‘Preserving the cultural heritage: An investigation into
the feasibility of the OAIS model for application in small organi-
sations,’’ Aslib Proc., vol. 58, no. 6, pp. 513–524, Nov. 2006, doi:
10.1108/00012530610713597.
[109] A. Belhi, A. Bouras, and S. Foufou, ‘‘Digitization and preservation of
cultural heritage: The CEPROQHA approach,’’ in Proc. 11th Int. Conf.
Softw., Knowl., Inf. Manag. Appl. (SKIMA), Dec. 2017, pp. 1–7, doi:
10.1109/SKIMA.2017.8294117.
[110] N. Freire, V . Charles, and A. Isaac, ‘‘Evaluation of Schema.org for
aggregation of cultural heritage metadata,’’ in Proc. Eur. Semantic
Web Conf. (Lecture Notes in Computer Science), vol. 10843, 2018,
pp. 225–239, doi: 10.1007/978-3-319-93417-4_15.
[111] N. Freire, G. Robson, J. B. Howard, H. Manguinhas, and A. Isaac,
‘‘Cultural heritage metadata aggregation using web technologies: IIIF,
sitemaps and Schema.Org,’’ Int. J. Digit. Libraries, vol. 21, no. 1,
pp. 19–30, Mar. 2020, doi: 10.1007/s00799-018-0259-5.
[112] T. Sidoroff and E. Hyvonen, ‘‘Semantic e-goverment portals—A case
study,’’ in Proc. Workshop Semantic Web Case Stud. Best Practices
eBusiness, 2005, pp. 1–8.
[113] E. Hyvönen, ‘‘Semantic portals for cultural heritage,’’ in Handbook on
Ontologies (International Handbooks on Information Systems), S. Staab
and R. Studer, Eds. Berlin, Germany: Springer, 2009, pp. 757–778, doi:
10.1007/978-3-540-92673-3_34.
[114] E. Hyvönen, E. Mäkelä, M. Salminen, A. Valo, K. Viljanen, S. Saarela,
M. Junnila, and S. Kettula, ‘‘MuseumFinland—Finnish museums on
the semantic web,’’ J. Web Semantics, vol. 3, nos. 2–3, pp. 224–241,
Oct. 2005, doi: 10.1016/j.websem.2005.05.008.
[115] E. Hyvonen, E. Makela, T. Kauppinen, O. Alm, J. Kurki, T. Ruotsalo,
K. Seppala, J. Takala, K. Puputti, H. Kuittinen, and K. Viljanen,
‘‘CultureSampo: A national publication system of cultural heritage on the
semantic web 2.0,’’ in Proc. Eur. Semantic Web Conf. (Lecture Notes in
Computer Science), vol. 5554, 2009, pp. 851–856, doi: 10.1007/978-3-
642-02121-3_69.
[116] E. Hyvönen, ‘‘Digital humanities on the semantic web: Sampo model and
portal series,’’ Semantic Web, vol. 14, no. 4, pp. 729–744, Apr. 2023, doi:
10.3233/sw-223034.
[117] M. Foulonneau, S. Martin, and S. Turki, ‘‘How open data are turned into
services?’’ in Proc. Int. Conf. Exploring Services Sci. (Lecture Notes
in Business Information Processing), vol. 169, 2014, pp. 31–39, doi:
10.1007/978-3-319-04810-9_3.
[118] C. Concordia, S. Gradmann, and S. Siebinga, ‘‘Not just another portal,
not just another digital library: A portrait of Europeana as an application
program interface,’’ IFLA J., vol. 36, no. 1, pp. 61–69, Apr. 2010, doi:
10.1177/0340035209360764.
[119] E. Coburn, R. Light, G. McKenna, R. Stein, and A. Vitzthum, ‘‘LIDO—
Lightweight information describing objects version 1.0,’’ ICOM/CIDOC
Work. Group Data Harvesting Interchange, Tech. Rep., 2010.
[Online]. Available: http://lido-schema.org/schema/v1.0/lido-v1.0-
specification.pdf
[120] T. Berners-Lee. (2006). Linked Data-Design Issues . Accessed: Jan. 11,
2024. [Online]. Available: http://www.w3.org/DesignIssues/LinkedData.
html and https://cir.nii.ac.jp/crid/1571417124256446848.bib?lang=en
[121] C. Bizer, T. Heath, and T. Berners-Lee, ‘‘Linked data: The story so far,’’
in Semantic Services, Interoperability and Web Applications: Emerging
Concepts. Hershey, PA, USA: IGI Global, 2011, pp. 205–227.
[122] C. Bizer, T. Heath, K. Idehen, and T. Berners-Lee, ‘‘Linked data on the
web (LDOW2008),’’ in Proc. 17th Int. Conf. World Wide Web, Apr. 2008,
pp. 1265–1266, doi: 10.1145/1367497.1367760.
[123] V . De Boer, J. Wielemaker, J. Van Gent, M. Hildebrand, A. Isaac,
J. Van Ossenbruggen, and S. Guus, ‘‘Supporting linked data production
for cultural heritage institutes: The Amsterdam museum case study,’’
in Proc. Extended Semantic Web Conf. (Lecture Notes in Computer
Science), vol. 7295, 2012, pp. 733–747, doi: 10.1007/978-3-642-30284-
8_56.
VOLUME 12, 2024 43023

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
[124] B. Haslhofer and A. Isaac, ‘‘The Europeana linked open data pilot,’’ in
Proc. Int. Conf. Dublin Core Metadata Appl., Sep. 2011, pp. 94–104.
[Online]. Available: https://dcpapers.dublincore.org/pubs/article/view/
3625
[125] A. Isaac and B. Haslhofer, ‘‘Europeana linked open data—
Data.europeana.eu,’’Semantic Web, vol. 4, no. 3, pp. 291–297, Jan. 2013,
doi: 10.3233/sw-120092.
[126] K. May, C. Binding, D. Tudhope, and S. Jeffrey, ‘‘Semantic technologies
enhancing links and linked data for archaeological resources,’’ in Proc.
39th Conf. Comput. Appl. Quant. Methods Archaeol. Amsterdam Univ.
Press, 2012, pp. 261–272, doi: 10.1017/9789048516865.030.
[127] P. Szekely, C. A. Knoblock, F. Yang, X. Zhu, E. E. Fink, R. Allen,
and G. Goodlander, ‘‘Connecting the smithsonian American art museum
to the linked data cloud,’’ in Proc. Extended Semantic Web Conf.
(Lecture Notes in Computer Science), vol. 7882, 2013, pp. 593–607, doi:
10.1007/978-3-642-38288-8_40.
[128] A. Gyrard, G. Atemezing, and M. Serrano, ‘‘PerfectO: An online
toolkit for improving quality, accessibility, and classification of domain-
based ontologies,’’ in Semantic IoT: Theory and Applications (Studies
in Computational Intelligence), vol. 941, R. Pandey, M. Paprzycki,
N. Srivastava, S. Bhalla, and K. Wasielewska-Michniewska, Eds. Cham,
Switzerland: Springer, 2021, pp. 161–192, doi: 10.1007/978-3-030-
64619-6_7.
[129] A. Gyrard and M. Serrano, ‘‘Connected smart cities: Interoperability
with SEG 3.0 for the Internet of Things,’’ in Proc. 30th Int. Conf.
Advanced Inf. Netw. Appl. Workshops, May 2016, pp. 796–802, doi:
10.1109/WAINA.2016.151.
[130] F. Pedro, M. Subosa, A. Rivas, and P. Valverde, ‘‘Artificial intelligence in
education: Challenges and opportunities for sustainable development,’’
UNESCO, Paris, France, 2019.
[131] B. Chakroun, F. Miao, V . Mendes, A. Domiter, H. Fan, I. Kharkova,
W. Holmes, D. Orr, M. Jermol, K. Issroff, J. Park, K. Holmes, H. Cromp-
ton, P. Portales, D. Orlic, and S. Rodriguez, ‘‘Artificial intelligence for
sustainable development: Synthesis report, mobile learning week 2019,’’
Teach. Learn. Fac. Publications, Tech. Rep. 117, 2019. [Online]. Avail-
able: https://digitalcommons.odu.edu/teachinglearning_fac_pubs/117
[132] C. Bonacchi and M. Krzyzanska, ‘‘Digital heritage research re-
theorised: Ontologies and epistemologies in a world of big data,’’ Int.
J. Heritage Stud., vol. 25, no. 12, pp. 1235–1247, Dec. 2019, doi:
10.1080/13527258.2019.1578989.
[133] R. Garozzo, C. Pino, C. Santagati, and C. Spampinato, ‘‘Harnessing the
power of artificial intelligence for modelling and understanding cultural
heritage data,’’ in Impact of Industry 4.0 on Architecture and Cultural
Heritage. Hershey, PA, USA: IGI Global, 2020, pp. 357–376.
[134] J. Dou, J. Qin, Z. Jin, and Z. Li, ‘‘Knowledge graph based on
domain ontology and natural language processing technology for Chinese
intangible cultural heritage,’’ J. Vis. Lang. Comput., vol. 48, pp. 19–28,
Oct. 2018, doi: 10.1016/j.jvlc.2018.06.005.
[135] G. Ioannakis, L. Bampis, and A. Koutsoudis, ‘‘Exploiting artificial
intelligence for digitally enriched museum visits,’’ J. Cultural Heritage,
vol. 42, pp. 171–180, Mar. 2020, doi: 10.1016/j.culher.2019.07.019.
[136] W. Lee and D.-H. Lee, ‘‘Cultural heritage and the intelligent Internet
of Things,’’ J. Comput. Cultural Heritage, vol. 12, no. 3, pp. 1–14,
Jun. 2019, doi: 10.1145/3316414.
[137] A. Belhi, H. Gasmi, A. K. Al-Ali, A. Bouras, S. Foufou,
X. Yu, and H. Zhang, ‘‘Deep learning and cultural heritage:
The CEPROQHA project case study,’’ in Proc. 13th Int. Conf.
Softw., Knowl., Inf. Manag. Appl. (SKIMA), Aug. 2019, pp. 1–5,
doi: 10.1109/SKIMA47702.2019.8982520.
[138] Y . Abgaz, R. Rocha Souza, J. Methuku, G. Koch, and A. Dorn,
‘‘A methodology for semantic enrichment of cultural heritage images
using artificial intelligence technologies,’’ J. Imag., vol. 7, no. 8, p. 121,
Jul. 2021, doi: 10.3390/jimaging7080121.
[139] A. Dorn, Y . Abgaz, G. Koch, and J. L. P. Díaz, ‘‘Harvesting knowledge
from cultural images with assorted technologies: The example of the
ChIA project,’’ in Knowledge Organization at the Interface: Proceedings
of the Sixteenth International ISKO Conference, 2020 Aalborg, Denmark.
Ergon-Verlag, 2020, pp. 470–473, doi: 10.5771/9783956507762-470.
[140] M. Hildebrand, J. Van Ossenbruggen, and L. Hardman, ‘‘Facet: A browser
for heterogeneous semantic web repositories,’’ in Proc. Int. Semantic
Web Conf. (Lecture Notes in Computer Science), vol. 4273, 2006,
pp. 272–285, doi: 10.1007/11926078_20.
[141] V . Petras, T. Hill, J. Stiller, and M. Gäde, ‘‘Europeana—A search engine
for digitised cultural heritage material,’’ Datenbank-Spektrum, vol. 17,
no. 1, pp. 41–46, Jan. 2017, doi: 10.1007/s13222-016-0238-1.
[142] K. Fernie, J. Griffiths, M. Stevenson, P. Clough, P. Goodale, M. Hall,
P. Archer, K. Chandrinos, E. Agirre, O. L. de Lacalle, and A. de Polo,
‘‘PATHS: Personalising access to cultural heritage spaces,’’ in Proc.
18th Int. Conf. Virtual Syst. Multimedia, 2012, pp. 469–474, doi:
10.1109/VSMM.2012.6365960.
[143] V . Haarslev and R. Möller, ‘‘Racer: A core inference engine for the
semantic web,’’ in Proc. EON, 2003, pp. 1–10.
[144] D. Tsarkov and I. Horrocks, ‘‘FaCT++ description logic reasoner:
System description,’’ in Proc. Int. Joint Conf. Automated Reasoning
(Lecture Notes in Computer Science), vol. 4130, 2006, pp. 292–297, doi:
10.1007/11814771_26.
[145] E. Sirin, B. Parsia, B. C. Grau, A. Kalyanpur, and Y . Katz, ‘‘Pellet:
A practical OWL-DL reasoner,’’ J. Web Semantics, vol. 5, no. 2,
pp. 51–53, Jun. 2007, doi: 10.1016/j.websem.2007.03.004.
[146] R. D. C. Shearer, B. Motik, and I. Horrocks, ‘‘Hermit: A highly-efficient
OWL reasoner,’’ in Proc. Owled, 2008, p. 91.
[147] D. A. Koutsomitropoulos and T. S. Papatheodorou, ‘‘Expressive reason-
ing about cultural heritage knowledge using web ontologies,’’ in Proc.
Int. Conf. Web Inf. Syst. Technol., 2007, pp. 276–281.
[148] G. Stapleton, M. Compton, and J. Howse, ‘‘Visualizing OWL 2 using
diagrams,’’ in Proc. IEEE Symp. Vis. Lang. Human-Centric Comput.,
VL/HCC, Nov. 2017, pp. 245–253, doi: 10.1109/VLHCC.2017.8103474.
[149] I. Horrocks, ‘‘OWL rules, ok?’’ W3C, Washington, DC, USA, 2005.
[150] I. Horrocks, P. F. Patel-Schneider, H. Boley, S. Tabet, B. Grosof, and
M. Dean, ‘‘SWRL: A semantic web rule language combining OWL and
RuleML,’’W3C Member submission, vol. 21, no. 79, pp. 1–31, 2004.
[151] C.-H. Lin, J.-S. Hong, and M. Doerr, ‘‘Issues in an inference platform for
generating deductive knowledge: A case study in cultural heritage digital
libraries using the CIDOC CRM,’’ Int. J. Digit. Libraries, vol. 8, no. 2,
pp. 115–132, Apr. 2008, doi: 10.1007/s00799-008-0034-0.
[152] E. Hyvonen, E. Makela, T. Kauppinen, O. Alm, J. Kurki, T. Ruotsalo,
K. Seppala, J. Takala, K. Puputti, H. Kuittinen, and K. Viljanen,
‘‘CultureSampo—Finnish culture on the semantic web 2.0. Thematic
perspectives for the end-user,’’ in Proc. Museums Web, 2009, pp. 15–18.
[153] P. Pauwels, R. Bod, D. Di Mascio, and R. De Meyer, ‘‘Integrating
building information modelling and semantic web technologies for the
management of built heritage information,’’ in Proc. Digit. Heritage
Int. Congr. (DigitalHeritage), vol. 1, Oct. 2013, pp. 481–488, doi:
10.1109/DigitalHeritage.2013.6743787.
[154] P. Drap, O. Papini, E. Pruno, M. Nucciotti, and G. Vannini, ‘‘Ontology-
based photogrammetry survey for medieval archaeology: Toward a 3D
geographic information system (GIS),’’ Geosciences, vol. 7, no. 4, p. 93,
Sep. 2017, doi: 10.3390/geosciences7040093.
[155] F. Noardo, ‘‘Architectural heritage semantic 3D documentation in multi-
scale standard maps,’’ J. Cultural Heritage, vol. 32, pp. 156–165,
Jul. 2018, doi: 10.1016/j.culher.2018.02.009.
[156] F. Windhager, P. Federico, G. Schreder, K. Glinka, M. Dörk,
S. Miksch, and E. Mayr, ‘‘Visualization of cultural heritage collection
data: State of the art and future challenges,’’ IEEE Trans. Vis.
Comput. Graphics, vol. 25, no. 6, pp. 2311–2330, Jun. 2019, doi:
10.1109/TVCG.2018.2830759.
[157] V . Vlahakis, M. Ioannidis, J. Karigiannis, M. Tsotros, M. Gounaris,
D. Stricker, T. Gleue, P. Daehne, and L. Almeida, ‘‘Archeogu-
ide: An augmented reality guide for archaeological sites,’’ IEEE
Comput. Graph. Appl., vol. 22, no. 5, pp. 52–60, Sep. 2002, doi:
10.1109/MCG.2002.1028726.
[158] M. K. Bekele, R. Pierdicca, E. Frontoni, E. S. Malinverni, and J. Gain,
‘‘A survey of augmented, virtual, and mixed reality for cultural heritage,’’
J. Comput. Cultural Heritage, vol. 11, no. 2, pp. 1–36, Mar. 2018, doi:
10.1145/3145534.
[159] D. Bruton, ‘‘Theorizing digital cultural heritage: A critical discourse,’’
Inf., Commun. Soc., vol. 14, no. 7, pp. 1077–1078, Oct. 2011, doi:
10.1080/1369118x.2010.542826.
[160] C. Van Aart, B. Wielinga, and W. R. Van Hage, ‘‘Mobile cultural heritage
guide: Location-aware semantic search,’’ in Proc. Int. Conf. Knowl. Eng.
Knowl. Manag. (Lecture Notes in Computer Science), vol. 6317, 2010,
pp. 257–271, doi: 10.1007/978-3-642-16438-5_18.
[161] S. Vert, B. Dragulescu, and R. Vasiu, ‘‘LOD4AR: Exploring linked open
data with a mobile augmented reality web application,’’ in Proc. ISWC,
2014, pp. 185–188.
[162] H. Kim, T. Matuszka, J.-I. Kim, J. Kim, and W. Woo, ‘‘Ontology-
based mobile augmented reality in cultural heritage sites: Information
modeling and user study,’’ Multimedia Tools Appl., vol. 76, no. 24,
pp. 26001–26029, Dec. 2017, doi: 10.1007/s11042-017-4868-6.
43024 VOLUME 12, 2024

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
[163] H. Park, E. Kim, H. Kim, J. Shin, J. Kim, K. Kim, and W. Woo, ‘‘K-
culture time machine: A mobile AR experience platform for Korean
cultural heritage sites,’’ in Proc. Int. Conf. Human Interface Manag. Inf.
(Lecture Notes in Computer Science), vol. 10905, 2018, pp. 167–180,
doi: 10.1007/978-3-319-92046-7_15.
[164] M. Weiser, ‘‘The computer for the 21 st century,’’ Sci. Amer., vol. 265,
no. 3, pp. 94–105, 1991. [Online]. Available: http://www.jstor.org/stable/
24938718
[165] B. Schilit, N. Adams, and R. Want, ‘‘Context-aware computing appli-
cations,’’ in Proc. 1st Workshop Mobile Comput. Syst. Appl., 1995,
pp. 85–90, doi: 10.1109/WMCSA.1994.16.
[166] A. K. Dey, ‘‘Understanding and using context,’’ Pers. Ubiquitous
Comput., vol. 5, no. 1, pp. 4–7, Feb. 2001, doi: 10.1007/s007790170019.
[167] C. Seifert, W. Bailer, T. Orgel, L. Gantner, R. Kern, H. Ziak, A. Petit,
J. Schlötterer, S. Zwicklbauer, and M. Granitzer, ‘‘Ubiquitous access to
digital cultural heritage,’’ J. Comput. Cultural Heritage, vol. 10, no. 1,
pp. 1–27, Apr. 2017, doi: 10.1145/3012284.
[168] T. Ruotsalo, K. Haav, A. Stoyanov, S. Roche, E. Fani, R. Deliai,
E. Mäkelä, T. Kauppinen, and E. Hyvönen, ‘‘SMARTMUSEUM: A
mobile recommender system for the web of data,’’ J. Web Semantics,
vol. 20, pp. 50–67, May 2013, doi: 10.1016/j.websem.2013.03.001.
[169] B. Ranjgar, A. Sadeghi-Niaraki, M. Shakeri, and S.-M. Choi, ‘‘An
ontological data model for points of interest (POI) in a cultural
heritage site,’’ Heritage Sci., vol. 10, no. 1, pp. 1–22, Dec. 2022, doi:
10.1186/s40494-021-00635-9.
[170] K. Kontiza, A. Antoniou, A. Daif, S. Reboreda-Morillo, M. Bassani,
S. González-Soutelo, I. Lykourentzou, C. E. Jones, J. Padfield,
and M. López-Nores, ‘‘On how technology-powered storytelling can
contribute to cultural heritage sustainability across multiple venues—
Evidence from the CrossCult H2020 project,’’ Sustainability, vol. 12,
no. 4, p. 1666, Feb. 2020, doi: 10.3390/su12041666.
[171] H. Wright and J. D. Richards, ‘‘Reflections on collaborative
archaeology and large-scale online research infrastructures,’’
J. Field Archaeol., vol. 43, no. sup1, pp. 60–67, Oct. 2018, doi:
10.1080/00934690.2018.1511960.
[172] M. Law and C. Morgan, ‘‘The archaeology of digital abandonment:
Online sustainability and archaeological sites,’’ Present Pasts, vol. 6,
no. 1, p. 2, May 2014, doi: 10.5334/pp.58.
[173] I. Lykourentzou, Y . Naudet, and L. Vandenabeele, ‘‘Reflecting on
European history with the help of technology: The crosscult project,’’ in
Proc. GCH, 2016, pp. 67–70.
[174] J. Huggett, ‘‘Reuse remix recycle: Repurposing archaeological digital
data,’’ Adv. Archaeological Pract., vol. 6, no. 2, pp. 93–104, May 2018,
doi: 10.1017/aap.2018.1.
[175] P. Webster, Cultural Heritage Infrastructures in Digital Humanities,
A. Benardou, E. Champion, C. Dallas, and L. M. Hughes, Eds. The
London School of Economics and Political Science (LSE), 2018.
[Online]. Available: https://blogs.lse.ac.uk/lsereviewofbooks/2018/02/
27/book-review-cultural-heritage-infrastructures-in-digital-humanities-
edited-by-agiatis-benardou-erik-champion-costis-dallas-and-lorna-m-
hughes/
[176] G. Trichopoulos, J. Aliprantis, M. Konstantakis, K. Michalakis,
P. Mylonas, Y . V outos, and G. Caridakis, ‘‘Augmented and personalized
digital narratives for cultural heritage under a tangible interface,’’ in Proc.
16th Int. Workshop Semantic Social Media Adaptation Personalization
(SMAP), Nov. 2021, pp. 1–5, doi: 10.1109/SMAP53521.2021.9610815.
[177] J. Duan and C.-C. Jay Kuo, ‘‘Bridging gap between image pixels and
semantics via supervision: A survey,’’ APSIPA Trans. Signal Inf. Process.,
vol. 11, no. 1, pp. 1–45, 2022.
[178] S. Vembu, M. Kiesel, M. Sintek, and S. Baumann, ‘‘Towards bridging the
semantic gap in multimedia annotation and retrieval,’’ in Proc. 1st Int.
Workshop Semantic Web Annotations Multimedia, 2006, pp. 1–12.
[179] S. Dasiopoulou, V . Tzouvaras, I. Kompatsiaris, and M. G. Strintzis,
‘‘Enquiring MPEG-7 based multimedia ontologies,’’ Multimedia Tools
Appl., vol. 46, nos. 2–3, pp. 331–370, Jan. 2010, doi: 10.1007/s11042-
009-0387-4.
[180] B. O’Neill and L. Stapleton, ‘‘Digital cultural heritage standards: From
silo to semantic web,’’ AI Soc., vol. 37, no. 3, pp. 891–903, Sep. 2022,
doi: 10.1007/s00146-021-01371-1.
[181] J. Efremova, B. Ranjbar-Sahraei, and T. Calders, ‘‘A hybrid disambigua-
tion measure for inaccurate cultural heritage data,’’ in Proc. 8th Workshop
Lang. Technol. Cultural Heritage, Social Sci., Humanities (LaTeCH),
2014, pp. 47–55.
[182] S. van Hooland, M. De Wilde, R. Verborgh, T. Steiner, and
R. Van de Walle, ‘‘Exploring entity recognition and disambiguation
for cultural heritage collections,’’ Digit. Scholarship Humanities, vol. 30,
no. 2, pp. 262–279, Jun. 2015, doi: 10.1093/llc/fqt067.
[183] G. Candela, P. Escobar, R. C. Carrasco, and M. Marco-Such, ‘‘A linked
open data framework to enhance the discoverability and impact of culture
heritage,’’ J. Inf. Sci., vol. 45, no. 6, pp. 756–766, Dec. 2019, doi:
10.1177/0165551518812658.
[184] A. Bikakis, R. Ferrario, S. Jean, B. Markhoff, A. Mosca, and
M. N. Asmundo, ‘‘Editorial: Special issue on semantic web and ontology
design for cultural heritage,’’ J. Comput. Cultural Heritage, vol. 16, no. 3,
pp. 1–5, Nov. 2023, doi: 10.1145/3626254.
[185] V . Borissova, ‘‘Cultural heritage digitization and related intellectual
property issues,’’ J. Cultural Heritage, vol. 34, pp. 145–150, Nov. 2018,
doi: 10.1016/j.culher.2018.04.023.
[186] E. Bertacchini and F. Morando, ‘‘The future of museums in the digital
age: New models for access to and use of digital collections,’’ Int. J. Arts
Manag., vol. 15, no. 2, pp. 60–72, 2013.
[187] K. Jagodzińska, J. Sanetra-Szeliga, J. Purchla, K. Van Balen, C. Thys,
A. Vandesande, and S. Van der Auwera, ‘‘Cultural heritage counts for
Europe full report,’’ CHCfE Consortium Int. Cultural Centre, Kraków,
Poland, Jun. 2015.
[188] I. Lykourentzou and A. Antoniou, ‘‘Digital innovation for cultural
heritage: Lessons from the European year of cultural heritage,’’ Scires-
Sci. Res. Inf. Technol., vol. 9, no. 1, pp. 91–98, Jul. 2019, doi:
10.2423/I22394303V9N1P91.
[189] S. Hahmann, D. Burghardt, and B. Weber, ‘‘‘80% of all information
is geospatially referenced’? Towards a Research Framework: Using the
semantic web for (in) validating this famous geo assertion,’’ in Proc. 14th
AGILE Conf. Geographic Inf. Sci., 2011, pp. 1–9.
[190] N. Aflaki, K. Stock, C. B. Jones, H. Guesgen, and J. Morley,
‘‘An empirical study of the semantic similarity of geospatial prepositions
and their senses,’’ Spatial Cognition Comput., vol. 23, no. 2, pp. 132–176,
Apr. 2023, doi: 10.1080/13875868.2022.2111683.
[191] D. J. Maguire, ‘‘An overview and definition of GIS,’’ Geographical Inf.
Syst., Princ. Appl., vol. 1, no. 1, pp. 9–20, 1991.
[192] M. J. Egenhofer, ‘‘Toward the semantic geospatial web,’’ in Proc.
ACM Workshop Adv. Geographic Inf. Syst., 2002, pp. 1–4, doi:
10.1145/585147.585148.
[193] W. Kuhn, ‘‘Geospatial semantics: Why, of what, and how?’’ in Journal
on Data Semantics III. Berlin, Germany: Springer, 2005, pp. 1–24.
[194] C. Dore and M. Murphy, ‘‘Integration of historic building information
modeling (HBIM) and 3D GIS for recording and managing cultural
heritage sites,’’ in Proc. 18th Int. Conf. Virtual Syst. Multimedia, 2012,
pp. 369–376, doi: 10.1109/VSMM.2012.6365947.
[195] M. Murphy, E. McGovern, and S. Pavia, ‘‘Historic building information
modelling (HBIM),’’ Structural Surv., vol. 27, no. 4, pp. 311–327,
Aug. 2009, doi: 10.1108/02630800910985108.
[196] T. H. Kolbe, G. Gröger, and L. Plümer, ‘‘CityGML: Interoperable access
to 3D city models,’’ in Geo-Information for Disaster Management,
P. van Oosterom, S. Zlatanova, and E. M. Fendel, Eds. Berlin, Germany:
Springer, 2005, pp. 883–899, doi: 10.1007/3-540-27468-5_63.
[197] E. Costamagna and A. Spano, ‘‘Semantic models for architectural
heritage documentation,’’ in Proc. Euro-Medit. Conf. (Lecture Notes in
Computer Science), vol. 7616, 2012, pp. 241–250, doi: 10.1007/978-3-
642-34234-9_24.
[198] A. L. Jancsc, B. Jonlet, P. Hoffsummer, E. Delye, and R. Billen,
‘‘An analytical framework for classifying software tools and systems
dealing with cultural heritage spatio-temporal information,’’ in Proc.
Int. Conf. Spatial Inf. Theory (Lecture Notes in Geoinformation and
Cartography), 2018, pp. 325–337, doi: 10.1007/978-3-319-63946-8_50.
[199] S. Bashir, S. Raza, and V . Misic, ‘‘BERT4Loc: BERT for location—POI
recommender system,’’ Future Internet, vol. 15, no. 6, p. 213, Jun. 2023,
doi: 10.3390/fi15060213.
[200] T. Kauppinen, P. Paakkarinen, E. Makela, H. Kuittinen, J. Vaatainen,
and E. Hyvonen, ‘‘Geospatio-temporal semantic web for cultural
heritage,’’ in Digital Culture and E-Tourism: Technologies, Applications
and Management Approaches, Hershey, PA, USA: IGI Global, 2011,
pp. 48–64.
[201] G.-A. Nys, M. Van Ruymbeke, and R. Billen, ‘‘Spatio-temporal reasoning
in CIDOC CRM: An hybrid ontology with GeoSPARQL and OWL-
time,’’ in Proc. CEUR Workshop. Aachen, Germany: RWTH Aachen
Univ., 2018, pp. 1–14.
VOLUME 12, 2024 43025

B. Ranjgar et al.: Cultural Heritage Information Retrieval: Past, Present, and Future Trends
[202] S. Perry, M. Roussou, S. S. Mirashrafi, A. Katifori, and S. McKinney,
‘‘Shared digital experiences supporting collaborative meaning-making at
heritage sites,’’ in The Routledge International Handbook of New Digital
Practices in Galleries, Libraries, Archives, Museums and Heritage Sites,
H. Lewi, W. Smith, D. vom Lehn, and S. Cooke, Eds. New York, NY ,
USA: Routledge, 2020, pp. 143–156.
[203] L. Bedford, ‘‘Storytelling: The real work of museums,’’ Curator,
Museum J., vol. 44, no. 1, pp. 27–34, Jan. 2001, doi: 10.1111/j.2151-
6952.2001.tb00027.x.
[204] A. Katifori, M. Karvounis, V . Kourtis, S. Perry, M. Roussou, and
Y . Ioanidis, ‘‘Applying interactive storytelling in cultural heritage: Oppor-
tunities, challenges and lessons learned,’’ in Proc. Int. Conf. Interact.
Digit. Storytelling (Lecture Notes in Computer Science), vol. 11318,
2018, pp. 603–612, doi: 10.1007/978-3-030-04028-4_70.
[205] S. Valtolina, ‘‘A storytelling-driven framework for cultural heritage
dissemination,’’ Data Sci. Eng., vol. 1, no. 2, pp. 114–123, Jun. 2016,
doi: 10.1007/s41019-016-0007-z.
[206] E. Yoo, O. Kwon, and J. Yu, ‘‘Evaluation of an augmented reality for his-
torical context experiences of 3D restored court paintings,’’ IEEE Access,
vol. 11, pp. 39197–39212, 2023, doi: 10.1109/ACCESS.2023.3268528.
[207] K. Kim, O. Kwon, and J. Yu, ‘‘Evaluation of an HMD-based
multisensory virtual museum experience for enhancing sense of
presence,’’ IEEE Access, vol. 11, pp. 100295–100308, 2023, doi:
10.1109/ACCESS.2023.3311135.
[208] D. Winer, ‘‘Review of ontology based storytelling devices,’’ in Language,
Culture, Computation. Computing of the Humanities, Law, and Narra-
tives (Lecture Notes in Computer Science), vol. 8002, N. Dershowitz
and E. Nissan, Eds. Berlin, Germany: Springer, 2014, pp. 394–405, doi:
10.1007/978-3-642-45324-3_12.
[209] A. Katifori, M. Karvounis, V . Kourtis, M. Kyriakidi, M. Roussou,
M. Tsangaris, M. Vayanou, Y . Ioannidis, O. Balet, T. Prados, and
J. Keil, ‘‘CHESS: Personalized storytelling experiences in museums,’’ in
Interactive Storytelling. Berlin, Germany: Springer,2014, pp. 232–235.
[210] A. Katifori, M. Roussou, S. Perry, G. Drettakis, S. Vizcay, and J. Philip,
‘‘The EMOTIVE project-emotive virtual cultural experiences through
personalized storytelling,’’ in Proc. Cira@ Euromed, 2018, pp. 11–20.
[211] D. Branco, A. Amato, S. Venticinque, and R. Aversa, ‘‘Agents
based cyber-physical diffused museums over web interoperability
standards,’’ IEEE Access, vol. 11, pp. 44107–44122, 2023, doi:
10.1109/ACCESS.2023.3272641.
[212] S. Bampatzia, O. G. Bravo-Quezada, A. Antoniou, M. L. Nores,
M. Wallace, G. Lepouras, and C. Vassilakis, ‘‘The use of semantics in
the CrossCult H2020 project,’’ in Proc. Int. KEYSTONE Conf. Semantic
Keyword-Based Search Structured Data Sources (Lecture Notes in
Computer Science), vol. 10151, 2017, pp. 190–195, doi: 10.1007/978-3-
319-53640-8_17.
[213] A. Chianese, F. Marulli, and F. Piccialli, ‘‘Cultural heritage and social
pulse: A semantic approach for CH sensitivity discovery in social media
data,’’ inProc. IEEE 10th Int. Conf. Semantic Comput. (ICSC), Feb. 2016,
pp. 459–464, doi: 10.1109/ICSC.2016.50.
[214] D. Korzun, S. Yalovitsyna, and V . V olokhova, ‘‘Smart services as cultural
and historical heritage information assistance for museum visitors and
personnel,’’Baltic J. Modern Comput., vol. 6, no. 4, pp. 1–16, 2018.
[215] S. E. Yalovitsyna, V . V . V olokhova, and D. G. Korzun, ‘‘Smart museum:
Semantic approach to generation and presenting information of museum
collections,’’ in Tools and Technologies for the Development of Cyber-
Physical Systems. Hershey, PA, USA: IGI Global, 2020, pp. 236–255.
[216] C. Antón, C. Camarero, and M.-J. Garrido, ‘‘Exploring the experi-
ence value of museum visitors as a co-creation process,’’ Current
Issues Tourism, vol. 21, no. 12, pp. 1406–1425, Aug. 2018, doi:
10.1080/13683500.2017.1373753.
BABAK RANJGAR was born in Tehran, Iran,
in 1995. He received the B.Sc. degree in geo-
matics engineering from Tabriz University, East
Azarbayjan Province, Iran, in 2017, and the
M.Sc. degree in GIS from the Geo-Information
Technology Department, Faculty of Geodesy and
Geomatics Engineering, K. N. Toosi University
of Technology, Tehran. He is currently pursuing
the Ph.D. degree in electrical engineering with
the Department of Energy, Politecnico di Milano,
Milan, Italy. His research interests include GIS, remote sensing, spatial
analysis, databases and data science, environmental hazards, electric power
distribution, and renewable energy.
ABOLGHASEM SADEGHI-NIARAKI (Member,
IEEE) received the B.Sc. degree in geomatics
engineering and the M.Sc. degree in geospatial
information system (GIS) engineering from the
Faculty of Geomatics Engineering, K. N. Toosi
University of Technology (KNTU), and the Ph.D.
degree in geo-informatics engineering from Inha
University, South Korea, in 2008. He is currently
an Associate Professor with the Computer Science
and Engineering Department, Sejong University,
South Korea. Previously, he held the position of an Assistant Professor
with the Geo-Informatics Engineering Department, Inha University. He is
a member of the XR Research Center for Real-Virtual Interconnected
Metaverse, approved by the Korean Ministry of Science and ICT. He has
extensive teaching experience at various universities, including Sejong
University, Inha University, and KNTU. His research interests include
GeoAI, XR (MR, VR, and AR), metaverse, ubiquitous GIS, healthcare, HCI,
and culture technology (CT).
MARYAM SHAKERIreceived the B.Sc. degree in
geomatics engineering from N. C. C. University,
and the M.Sc. and Ph.D. degrees in geospatial
information system (GIS) engineering from the
Faculty of Geomatics Engineering, K. N. Toosi
University of Technology (KNTU). Currently, she
holds a position as a Postdoctoral Researcher
at the Graduate School of Culture Technology
at the Korea Advanced Institute of Science and
Technology (KAIST). She has previously worked
as a Researcher at the UVR Laboratory, KAIST, accumulating over two years
of experience there. She has teaching experience at various universities in
Iran and the JKIP international program, a joint course between KNTU and
the University of Twente (UT). She has actively participated in numerous
funded research projects, both at the national and international levels,
focusing on the cutting-edge fields of GIS and AR technology. Her current
research passion revolves around the practical application of ubiquitous GIS
(UGIS), while her broader research interests encompass culture technology,
augmented reality, smart cities, ontology, and machine learning.
FATEMA RAHIMI received the M.Sc. degree in
geospatial information system (GIS) engineering
from the Department of GIS Engineering, Faculty
of Geomatics Engineering, K. N. Toosi Univer-
sity of Technology (KNTU). She is currently
pursuing the Ph.D. degree in computer science
and engineering with Sejong University. Her
research interests include spatial studies, artificial
intelligence, augmented and virtual reality, and the
Internet of Things.
SOO-MI CHOI (Member, IEEE) received the
B.S., M.S., and Ph.D. degrees in computer science
and engineering from Ewha Womans University,
South Korea, in 1993, 1995, and 2001, respec-
tively. She is currently a Professor in computer
science and engineering with Sejong University,
South Korea, and the Director of the eXtended
Reality Research Center Designated by the Min-
istry of Science and ICT of Korea. She was a
Visiting Researcher with the Fraunhofer Institute
for Computer Graphics Research, Germany, in 1998. She joined the
Faculty of Computer Science and Engineering, Sejong University, in 2002.
From 2008 to 2009, she was a Visiting Professor with the CG Laboratory,
ETH Zürich, Switzerland. She is also the Chief Vice President of the Korea
Computer Graphics Society and the Vice President of the HCI Society
of Korea. Her research interests include XR (VR/AR/MR), metaverse,
computer graphics, HCI, and biomedical imaging.
43026 VOLUME 12, 2024
